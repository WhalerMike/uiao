...
[DIAGRAM-01: Top-down drift-severity routing flowchart. Root pill-shaped box at top: "Drift Detected". Below it, a diamond decision box: "Severity". Three severity branches fan out from the diamond, each labeled with its severity tier: "Low" → "Auto-Remediate" (teal); "Medium" → "Notify Owner + Auto-Remediate" (amber); "High" → "Escalate + Manual Review" (red). All three remediation branches converge into a single terminal box at the bottom: "Provenance Log". Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for root and decision, three-tone severity gradient (teal / amber / red) on the branch outcomes, federal navy for the log terminus, monospace labels, 16:9 landscape.]
