...
|---|---|---|
| Vol I Book 01 (DDI — DNS/DHCP/IPAM) | Grid replication with alternate Grid member in DR region | CP-6: alternate storage for DNS zone data; CP-7: alternate processing for name resolution; CP-8: DNS continuity supports all other failover dependencies |
