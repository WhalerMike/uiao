...
| Part 11 (Network Segmentation) | Firewall and micro-segmentation policy backup | CP-6: configuration baseline for firewall rules stored in alternate region; CP-7: network policy can be restored at alternate site |
| Part 12 (Compliance Automation) | Configuration state and compliance baseline exports | CP-6: configuration baselines (device management policy exports, compliance rules) stored in alternate Key Vault |
