---
title: "Vol III Book 05 — Federal Application-Aware Networking — Data Protection: Microsoft Purview and Cryptographic Key Management"
...
::: {.callout-important}
**Series Context** — This document is Vol III Book 05 of the Federal Application-Aware Networking series. The Volume I network-and-identity books and the Volume II database books establish Landing Zone IPAM/DDI/PKI, Network Access Control, Certificates and Tokens, Network Modernization, Telecommunications Modernization, SQL Server Authentication Modernization, SQL Server Implementation, and Database Consolidation and Network Physics. Vol III Book 01 addresses Privileged Access Management. Vol III Book 06 addresses Security Operations, Monitoring, and Incident Response. This part addresses the data layer: what the data is, where it is allowed to go, and whether it is cryptographically protected at rest and in transit.
:::
