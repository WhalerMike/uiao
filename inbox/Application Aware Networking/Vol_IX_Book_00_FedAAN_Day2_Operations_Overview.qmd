...
This overview establishes the day-2 operations layer of the series, extending Volume VII's coordination doctrine. Functions and planes are named, not organizations; ServiceNow is the deployed coordination example; the substitution path is preserved where a workflow platform is interchangeable. Every book carries a Date Code. The volume map above is authored as committed house-style SVG per ADR-093, rendered to PNG at 3× for crisp `.docx` zoom; further per-book figures follow in the figure pass.
