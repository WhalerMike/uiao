...
|---|---|---|---|---|---|---|---|
| CM-8 † | System Component Inventory | IPAM-keyed asset identity as the join key correlating all native-stack inventories (naming-plane necessity) | FedRAMP Moderate | NIST SP 800-53 Rev 5; CISA BOD 23-01 | Network | KSI-CMT | No |
...
**KSI-MLA** (Monitoring, Logging, Alerting); the CM family feeds **KSI-CMT**
