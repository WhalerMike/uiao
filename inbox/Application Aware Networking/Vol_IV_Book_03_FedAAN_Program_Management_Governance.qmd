...
Vol I Book 05 evidence artifacts satisfy CM-8(1) automated inventory updates for
the identity plane.
...
|---------------|-------------|------------|----------|
| Tier 1: SBOM | Machine-readable SBOM for all systems | Implemented | Vol IV Book 02, Syft pipeline |
| Tier 2: VDR | Vulnerability Disclosure Report | Implemented | Vol IV Book 02, Grype output |
| Tier 3: VER | Vulnerability Exploitability eXchange | Implemented | Vol IV Book 02, OpenVEX JSON |
