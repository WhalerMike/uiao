---
title: "Book 06 — Federal Application-Aware Networking: SQL Server Authentication Modernization"
...
::: {.callout-important}
**Series Context** — This document is Part 6 of the Federal Application-Aware Networking series. Parts 1–5 cover Landing Zone IPAM/DDI/PKI, Network Access Control, Certificates and Tokens, Network Modernization, and Telecommunications Modernization. This part addresses the authentication layer of SQL Server — the protocol, credential, and identity surface that persists after network controls are in place.
:::
