...
| `saas.credential.rotate` | Automated rotation ahead of expiry, SaaS-side update tracked as a change. The trust never depends on a human remembering a three-year certificate | owner | **IA-5** |
