...
| **SA-15** | Development Process, Standards, and Tools | The slot evaluator, series origin, and diagram pipeline are documented design decisions of record covering the development process used to build the evidence pipeline; the `uiao` CI/CD gate (ruff, mypy, pytest 4768 tests) is the SA-15 toolchain evidence |
