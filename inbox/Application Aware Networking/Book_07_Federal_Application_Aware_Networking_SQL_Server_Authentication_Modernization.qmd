...
::: {.callout-important}
**Series Context** — This document is Part 7 of the Federal Application-Aware Networking series. Parts 1–6 cover Landing Zone IPAM/DDI/PKI, Network Access Control, Certificates and Tokens, HRIT and the Identity & Organizational SSOT, Network Modernization, and Telecommunications Modernization. This part addresses the authentication layer of SQL Server — the protocol, credential, and identity surface that persists after network controls are in place.
:::
