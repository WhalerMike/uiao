...
**Four books formalize the extension:** Network Enforcement Substrate (Vol I Book 07), Patch & Systems Management (Vol III Book 03), Cloud-Native Security Posture & Containers (Vol III Book 04), and the Multi-Cloud Evidence Fabric (Vol III Book 07). Multi-CSP sections were also added to Privileged Access Management (Vol III Book 01), Data Protection (Vol III Book 05), and Business Continuity (Vol IV Book 01). The series is now organized in **five volumes** — a program volume plus Volumes I–IV.

**Reconciliation of the headline figures:**

- **Book count** — twenty-three implementation books (was nineteen), plus this Executive Summary, the Product Inventory Questionnaire, and four volume overviews.
