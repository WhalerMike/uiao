...
| Vol VII Book 06 | Federal AAN — SaaS Integration Governance | SA-9 †, CA-3, AC-20 · verify authorization, then configure | Entra gallery · FedRAMP Marketplace · ServiceNow |
...
| [Vol VII Book 06 — SaaS Integration Governance](Vol_VII_Book_06_FedAAN_SaaS_Integration_Governance.qmd) | Vol VII Book 06: onboarding a third-party SaaS as the governed SA-9 event that closes 24 controls — verify authorization, then configure, never the reverse |
