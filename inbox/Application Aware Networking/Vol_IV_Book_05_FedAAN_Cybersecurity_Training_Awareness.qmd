...
- **Internal ADR-111 rule-set coverage:** 28/29 → **29/29 active** — all 29
  internal rules are now evaluable (this is the internal ADR-111 rule set, **not**
...
**This makes all 29 internal ADR-111 rules active/evaluable; it does not complete
...
the internal ADR-111 rule set** — pending CR26 reconciliation and independent SCA.
