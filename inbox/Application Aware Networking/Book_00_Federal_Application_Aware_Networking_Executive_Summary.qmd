...
subtitle: "Executive Summary — NIST SP 800-53 Rev 5 Control Closure Across Eighteen Parts"
...
This document summarizes eighteen companion implementation guides that together constitute the Federal Application-Aware Networking program. Books 01–03 lay the substrate: the DDI/IPAM naming-and-addressing plane (16 controls), 802.1X network access control closing the device-identity gap at the network port, and the certificate-and-token cryptographic identity layer that every session-less architecture depends on. Books 04–08 deliver the modernization tracks — telecommunications (SD-WAN + SASE), network and identity architecture (Entra ID + ZTNA + Active Governance), SQL Server authentication, and database architecture and network physics — closing **34 distinct NIST SP 800-53 Rev 5 controls** across the original six tracks. Books 09–13 extend coverage to privileged access management, vulnerability management, data protection, SIEM/XDR detection engineering, and business continuity — adding approximately **55 additional controls** across the AC, RA, MP, SC, AU, SI, IR, and CP families. Books 14–16 close the remaining SR, PM, and PT control families — supply chain risk management (SBOM/VDR/VEX pipeline), program management governance (POA&M/SCRM/ISPP), and PII processing transparency (PT family templates and Purview enforcement). Book 17 delivers the AT family cybersecurity training program — activating KSI-022 (KSI-CED-RAT) and making all 29 FedRAMP 20x CR26 KSIs evaluable at high confidence. Book 18 assembles the complete FedRAMP 20x authorization package — OSCAL AP+AR+POA&M bundle (29/29 KSIs self-assessed as satisfied, 0 open risks, pending independent 3PAO validation), continuous monitoring program, and BOD 26-04 VDR/VER submission procedure — closing CA-2, CA-5, CA-6, CA-7, RA-3, and SA-15. Together the series constitutes the complete evidence generation and authorization layer required for FedRAMP 20x continuous monitoring authorization.
...
**The eighteen implementations described in this series are not optional modernization projects.** They are the structural prerequisites for operating at FedRAMP Moderate authorization under FedRAMP 20x rules, which are mandatory for all certified systems effective January 1, 2027.
:::
...
| Part 4 | Federal AAN — Federal Telecommunications Modernization | Amazon Connect · Teams Phone · SD-WAN · SASE | SD-WAN / SASE stack |
...
| Part 6 | Federal AAN — SQL Server Authentication Modernization | SQL credential elimination · Arc Managed Identity · NTLM elimination | Azure Arc + Entra ID for SQL |
| Part 7 | Federal AAN — SQL Server Implementation Guide | 10-book runbook: estate audit, Arc deployment, login migration, monitoring | Azure Arc + Entra ID (implementation) |
| Part 8 | Federal AAN — Database Consolidation and Network Physics | SSOT architecture · SD-WAN for database traffic · consistency class alignment | SQL + Network Physics |
| Part 9 | Federal AAN — Privileged Access Management | Entra PIM JIT activation · PAW architecture · AC-6 least privilege | Entra PIM + PAW |
| Part 10 | Federal AAN — Vulnerability Management | Defender VM · CISA KEV integration · RA-5 continuous scanning | Defender MDVM + KEV |
| Part 11 | Federal AAN — Data Protection and Purview | Purview DLP · sensitivity labels · Key Vault CMK · MP/SC controls | Purview + Key Vault |
| Part 12 | Federal AAN — SIEM / XDR / Detection Engineering | Sentinel connectors · KQL analytics rules · UEBA scoring · Logic App playbooks | Microsoft Sentinel + Defender XDR |
| Part 13 | Federal AAN — Business Continuity | CP-2 contingency plan · BIA RTO/RPO/MTD · SQL AG and DDI DR integration | Azure Site Recovery + DR runbooks |
| Part 14 | Federal AAN — Supply Chain Risk Management | Syft CycloneDX SBOM · Grype VDR · OpenVEX exploitability · GitHub Actions pipeline | BOD 26-04 / SR-family |
| Part 15 | Federal AAN — Program Management and Governance | ISPP · POA&M · SCRM Charter · Leadership RACI · PM-1/PM-9/PM-30 closure | PM-family governance artifacts |
| Part 16 | Federal AAN — PII Processing and Transparency | PT family templates · Privacy Program Plan · authority-to-process · Purview Data Map | PT-1–PT-7 GCC Moderate |
| Part 17 | Federal AAN — Cybersecurity Awareness and Training | AT-2/AT-3 general and role-based training · LMS evidence schema · CP-3 tabletop calendar · IR-2 drill documentation | AT/CP/IR families · KSI-CED-RAT |
| Part 18 | Federal AAN — Authorization Package and ConMon | FedRAMP 20x authorization package · OSCAL AP+AR+POA&M bundle · BOD 26-04 VDR/VER submission · CA-7 ConMon program | CA-2/5/6/7 · RA-3 · SA-15 |

: Federal Application-Aware Networking Series — Books 00–18 {.striped .hover}
...
these eighteen books belongs to one of six functional planes. The planes are
...
|---|---|---|---|
| **1 — Transport** | Move packets between sites and clouds | Circuits, MPLS → DIA, SD-WAN overlay, path selection, QoS | Parts 4, 8 |
...
| **3 — Identity** | Assert who and what is requesting | Device identity (NAC/802.1X), user identity (Entra ID), workload identity, tokens (OAuth/OIDC, CBA) | Parts 2, 3, 5 |
| **4 — Policy enforcement** | Decide and enforce per session | SASE (SWG/CASB/FWaaS), ZTNA, TIC 3.0 PEPs, Conditional Access | Parts 4, 5 |
| **5 — Application & experience** | Deliver the mission service | Contact center, unified communications, business applications, databases | Parts 4, 6–8 |
| **6 — Evidence & telemetry** | Prove continuously what happened | SIEM/XDR, per-session records, OSCAL bundle, KSI evidence pipeline | Parts 12, 18 |
...
|---|---|---|---|
| Forward proxy · VPN concentrator · SWG appliance | SASE/SSE (SWG, CASB, ZTNA) | Policy enforcement (plane 4) | Parts 4–5 |
...
|-------|----------|---------|
| **1 — Understand** | Identify control gaps and their architectural root causes | This series — Books 00–16 |
| **2 — Design** | Select the architectural pattern that closes each gap with continuous evidence | This series — domain books 01–13 |
| **3 — Implement** | Execute the runbooks, deploy the infrastructure, configure the integrations | This series — Part 7 (SQL), domain books |
| **4 — Govern** | Establish SCRM, POA&M, ISPP, and RACI structures | This series — Books 14–16 |
...
- **ScuBA-based rules attest 10 of the 29 active FedRAMP 20x CR26 KSI rules**
  ...
  configuration state, which is exactly the surface SCuBAGear measures.
- **The other 19 rules bind to evidence slots that exist only because the
  architecture in Parts 1–18 was built** — supply-chain evidence from the SBOM
...
attest it, and which evidence slot and series part carry it. Book 18 documents
...
|---|---|---|---|---|---|
| KSI-001..010 (10) | M365 baseline (IAM/MLA/CNA/SVC configuration surface) | Microsoft 365 GCC tenant configuration against the CISA SCuBA baseline | **Yes — ScuBAGear** | ScuBA adapter (no slot binding) | Validation phase (after Parts 1–5 make the baseline the natural steady state) |
| KSI-011..014 (4) | SCR — VDR/VER contract | SBOM/VDR/VEX pipeline (Syft, Grype, OpenVEX) under BOD 26-04 | No | slot-06 security | Part 14 |
| KSI-015..016 (2) | SCR-MIT / SCR-MON | SCRM charter + continuous supply-chain monitoring | No | slot-06 security | Parts 14–15 |
| KSI-017..021 (5) | PIY (GIV/RES/RIS/RSD/RVD) | Privacy program, PII data-flow maps, Purview Data Map integration | No | slot-05 endpoint | Part 16 |
| KSI-022 (1) | CED-RAT | Machine-readable training-effectiveness record (LMS → Graph API export) | No | slot-08 training | Part 17 |
| KSI-023..029 (7) | CED / INR / RPL | Sentinel/XDR incident playbooks + DR/continuity architecture | No | slot-07 continuity, slot-04 telemetry | Parts 12–13 |
...
identity slot (slot-01) draws on Parts 3, 5, and 9; the network slot (slot-03)
on Parts 1, 2, and 4; the data and telemetry slots (slot-02, slot-04) on Parts
...
multipath (Part 4 documents the mechanism). Part 3 establishes what replaces
...
25-01), and machine/workload identity. Parts 6–7's SQL Server authentication
...
and Parts 6–7 database closures stand.

---

# Part 4 — Telecommunications Modernization: SD-WAN + SASE Closes 7 NIST Controls
...
: Part 4 — NIST SP 800-53 Rev 5 Control Closure: SD-WAN + SASE for Telecommunications {.striped .hover}
...
: Part 4 — Additional Controls for Amazon Connect Boundary Compliance {.striped .hover}
...
# Parts 6–8 — SQL Server and Database Architecture

## What These Documents Address

Parts 6 through 8 address the authentication surface, implementation runbooks, and infrastructure architecture for SQL Server — the database tier that underlies most SSA business systems. The database layer carries the same credential vulnerabilities as the identity and network layers addressed in Parts 1–5: stored passwords in SQL logins, NTLM fallback in database authentication, manual credential rotation, and no continuous compliance evidence.

**Part 6 (SQL Server Authentication Modernization)** is the conceptual guide: Arc Managed Identity replaces stored credentials, NTLM is eliminated in three phases, logins are migrated using a parallel-run pattern, and Entra Conditional Access becomes the outer authentication perimeter for SQL.

**Part 7 (SQL Server Implementation Guide)** is the operational runbook: ten sequential books covering estate discovery, authentication audit, Arc deployment, login migration, NTLM detection and remediation, Entra group structure, application chain migration, continuous monitoring, and certificate lifecycle.

**Part 8 (Database Consolidation and Network Physics)** addresses the architectural substrate: logical vs. physical centralization, the speed-of-light propagation floor that constrains cross-region consistency, SD-WAN traffic class separation for database replication traffic, token-based security as a database consolidation enabler, and the consistency class to transport class alignment rule.

## NIST Control Closure — Parts 6 and 7 (SQL Server Authentication)
...
: Parts 6-7 — NIST SP 800-53 Rev 5 Control Closure: SQL Server Authentication Modernization {.striped .hover}

**Controls closed (Parts 6-7):** IA-2, IA-3, IA-5, AC-2, AC-3, AC-17, AU-2/AU-12, CA-7, CM-2/CM-8, SC-8, SI-4 — all are deepened closures of controls addressed in Parts 1–5 at the identity and network layers, now extended to the database authentication layer.

## NIST Control Closure — Part 8 (Database Architecture and Network Physics)
...
: Part 8 — NIST SP 800-53 Rev 5 Control Closure: Database Consolidation and Network Physics {.striped .hover}

**Net new controls from Part 8** (not addressed in Parts 1–7): SC-28, SC-5, CA-3, SA-8, AU-9, CP-9, CP-10 — **7 additional controls**, bringing the series total to **34 distinct controls**.

---

# Parts 9–18 — Expanded Control Coverage

Parts 9 through 13 extend the series from the network and identity planes into
the operational security planes: privileged access, vulnerability management,
data protection, detection engineering, and contingency planning — adding approximately **55 additional controls**. Parts 14–16 close the three control families the network and security architecture documents cannot address on their own: supply chain risk management, program management governance, and PII processing transparency.

## NIST Control Closure — Parts 9–18

| Part | Topic | Target Controls | Technology |
|------|-------|-----------------|------------|
| **Part 9** | Privileged Access Management | AC-5, AC-6, AC-6(1/2/5/7/9/10), AC-11, AC-12, IA-11 | Entra PIM + PAW |
| **Part 10** | Vulnerability Management | RA-5, RA-5(2), RA-5(5), SI-2, SI-2(2), SI-5, CM-7, CM-7(1) | Defender MDVM + CISA KEV |
| **Part 11** | Data Protection | MP-2, MP-3, MP-4, MP-5, SC-12, SC-13, SC-17, SC-28, AU-10 | Purview + Key Vault CMK |
| **Part 12** | SIEM / XDR / Detection Engineering | AU-6, AU-6(1/3), AU-7, AU-8, AU-11, SI-4, SI-4(2/4/5), IR-4, IR-6, IR-8 | Microsoft Sentinel + Defender XDR |
| **Part 13** | Business Continuity | CP-2, CP-2(1/2/3), CP-3, CP-4, CP-4(1/2), CP-6, CP-7, CP-7(1/2/3), CP-8, CP-8(1/2) | Azure Site Recovery + DR runbooks |
| **Part 14** | Supply Chain Risk Management | SR-1, SR-2, SR-3, SR-5, SR-6, SR-8, SR-10, SR-11 | Syft/Grype SBOM pipeline + BOD 26-04 |
| **Part 15** | Program Management and Governance | PM-1, PM-2, PM-5, PM-7, PM-9, PM-11, PM-14, PM-15, PM-30 | ISPP / POA&M / SCRM Charter templates |
| **Part 16** | PII Processing and Transparency | PT-1, PT-2, PT-3, PT-4, PT-5, PT-7 | Purview Data Map + PT family templates |
| **Part 17** | Cybersecurity Awareness and Training | AT-2, AT-2(1), AT-2(2), AT-3, AT-3(3), AT-3(5), AT-4, CP-3, IR-2 | LMS · Viva Learning · Microsoft 365 Compliance |
| **Part 18** | Authorization Package and ConMon | CA-2, CA-5, CA-6, CA-7, CA-7(1), CA-7(3), RA-3, SA-15 | OSCAL AP+AR+POA&M · BOD 26-04 VDR/VER · ConMon dashboard |

: Parts 9–18 — NIST SP 800-53 Rev 5 Control Coverage {.striped .hover}

**KSI alignment:** Parts 9–13 map to KSI-MLA (Monitoring, Logging, Alerting),
KSI-SVC (Service Configuration), and KSI-IAM (Identity and Access Management)
themes in the FedRAMP 20x Consolidated Rules. Part 12 (Sentinel) is the primary
MLA evidence source; Parts 9 and 10 contribute KSI-IAM-ELP (Least Privilege) and
KSI-MLA-ALA (Analyzing and Acting on Alerts) respectively. Parts 14–16 map to
...
process artifacts rather than infrastructure configuration. **Part 17 activates
...
Conformance Adapter and makes all 29 CR26 KSIs evaluable. **Part 18 converts
...
![NIST SP 800-53 Control Closure by Family and Track — All Six Parts](figs/es-fig-02-control-closure-chart.png){fig-alt="Horizontal stacked bar chart showing NIST control families on the Y axis and count of controls closed on the X axis, stacked by Part 1 navy, Part 4 teal, Part 5 amber, Parts 6-8 SQL green. Families include SC, IA, CM, AU, AC, CA, SI, CP, IR, SA, PL. White background." width="100%"}

## Total Controls Closed Across the Original Six Tracks (Parts 1, 4–8)

| Control Family | Technology | Controls Closed | Implementing Track |
|---|---|---|---|
| **SC** — System and Communications Protection | InfoBlox DNSSEC, RPZ, PKI; SD-WAN IPsec; SASE SWG; TDE; QoS | SC-5, SC-7, SC-7(7), SC-8, SC-8(1), SC-20, SC-20(1), SC-21, SC-22, SC-28 | Parts 1, 4, 5, 8 |
| **CM** — Configuration Management | InfoBlox IPAM; Active Governance; SQL estate inventory | CM-2, CM-6, CM-8, CM-8(1) | Parts 1, 5, 6-7 |
| **AU** — Audit and Accountability | InfoBlox Syslog; SASE Session Logs; Entra ID Logs; Geo-replicated audit | AU-2, AU-9, AU-12 | Parts 1, 4, 5, 6-7, 8 |
| **IA** — Identification and Authentication | InfoBlox PKI / SCEP; Entra ID Conditional Access; Intune MDM; Arc + Entra for SQL | IA-2, IA-2(1), IA-3, IA-5, IA-5(2), IA-8, IA-9 | Parts 1, 5, 6-7 |
| **AC** — Access Control | SASE CASB; ZTNA; Entra ID HRIT; SQL Entra groups | AC-2, AC-3, AC-4, AC-17 | Parts 4, 5, 6-7 |
| **CA** — Assessment, Authorization, and Monitoring | SASE; Active Governance; SQL compliance record; Entra cross-system token | CA-3, CA-7 | Parts 4, 5, 6-7, 8 |
| **CP** — Contingency Planning | DR replica + backup; DR runbook | CP-9, CP-10 | Part 8 |
| **IR** — Incident Response | InfoBlox RPZ + SIEM Integration | IR-4, IR-5 | Part 1 |
| **SA** — System and Services Acquisition | InfoBlox DNS Forwarders; SSP Documentation; Consistency class design | SA-8, SA-9 | Parts 1, 4, 8 |
| **SI** — System and Information Integrity | InfoBlox RPZ + TIDE; SASE SWG; Entra ID HRIT; NTLM monitoring | SI-3, SI-3(1), SI-4, SI-12 | Parts 1, 4, 5, 6-7 |
...
| Part 4 — SD-WAN + SASE (Telecom) | SD-WAN IPsec + SASE (SWG, CASB, FWaaS, ZTNA) | 7 open; DIA alone satisfies none | 7 closed by SASE stack | 7 controls automated |
...
| Parts 6–7 — SQL Server Authentication | Azure Arc + Entra ID for SQL; NTLM elimination | Authentication layer open across all SQL instances | Controls deepened to database tier; continuous SQL compliance record | SQL auth surface closed |
| Part 8 — Database Architecture + Network Physics | TDE; SD-WAN QoS; DR architecture; consistency alignment | 7 distinct controls open | 7 net new controls closed | 7 controls added to series |
...
> **Why 34 distinct controls:** Several controls appear across multiple tracks (SC-7, SC-8, SC-20/21, AU-2/AU-12, CM-8, CA-7). Where multiple tracks address the same control at different layers (e.g., DNS-layer SC-7 in Part 1, network-layer SC-7 in Part 4, database-layer authentication in Parts 6–7), both implementations contribute. The 34 count is of distinct control numbers — the total implementation coverage across all layers of each control is broader.
...
# Previously Identified Gaps — Now Closed by Parts 14–16

Three NIST SP 800-53 control families required additional artifacts beyond
network and security architecture documents. Parts 14–16 were authored to close
...
through KSI-014 (KSI-SCR-MIT and KSI-SCR-MON) are now evaluable through Part 14.

**Controls closed:** SR-1, SR-2, SR-3, SR-5, SR-6, SR-8, SR-10, SR-11

**Part 14 — Supply Chain Risk Management** delivers: Syft CycloneDX SBOM
...
**Part 15 — Program Management and Governance** delivers: ISPP template,
...
**Part 16 — PII Processing and Transparency** delivers: Privacy Program Plan,
authority-to-process templates, SORN/PIA scaffolding, and Purview Data Map
enforcement integration with Part 11 sensitivity labels. KSI-PIY-RSD activated
at high confidence.
...
**Part 17 — Cybersecurity Awareness and Training** delivers: role-based training
...
addressed: SCR and PIY by Parts 14–16, CED by Part 17. INR (Incident
Notification and Response) and RPL (Replication and Continuity) are served
by Parts 12–13 through Sentinel/XDR playbooks and the Business Continuity
...
The eighteen-book series generates evidence. The **Conformance Adapter** is the
...
| Surface slots 1–8 (all slots) | Bound to AAN evidence | slot-08 training activated by Part 17 |
...
![Implementation Sequencing — Path to FedRAMP 20x Mandatory Compliance by January 1 2027](figs/es-fig-04-sequencing-roadmap.png){fig-alt="Horizontal timeline from July 2026 to June 2027 with milestone circles showing Class A opens August 3 2026, Class B and C open August 31 2026, FedRAMP Ready ceases July 28 2026 in red, FedRAMP 20x mandatory January 1 2027 in red, new Rev5 certs cease June 11 2027 in red. Three track bars: Part 1 InfoBlox DDI spans full timeline, Part 4 SD-WAN plus SASE concurrent, Part 5 Entra ID plus ZTNA multi-phase. White background." width="100%"}
...
| **1b — Precedes Parts 5–7** | Part 3: Certificates & Tokens | Entra ID CBA + ACME + managed identity | Certificate and token doctrine is the prerequisite for the identity modernization (Part 5) and SQL authentication (Parts 6–7) tracks; the certificate pipeline it establishes is the same one Part 2's machine certificates ride. |
| **2 — Concurrent with Part 1** | Part 4: SD-WAN + SASE | SD-WAN (Cisco/VMware/Palo Alto) + SASE (Zscaler/Netskope/Prisma) | The G.114 compliance failure (Amazon Connect latency) is an active operational problem generating citizen-facing quality failures today. DIA + SASE deployment is the fastest path to a measurable operational improvement and closes 7 NIST controls simultaneously. |
...
| **4 — In parallel with Part 5** | Parts 6–7: SQL Server Authentication | Azure Arc + Entra ID for SQL; NTLM elimination program | Arc enrollment enables SQL Entra auth independently of the full AD-to-Entra migration. Can begin on SQL instances before the broader Entra migration completes. NTLM Phase A (discovery) can begin immediately. |
| **5 — Concurrent with Parts 6–7** | Part 8: Database Architecture | TDE; SD-WAN QoS for DB traffic; DR architecture; consistency alignment | TDE can be applied immediately; SD-WAN QoS for database traffic is a configuration change if SD-WAN is deployed; DR architecture is an ongoing program. |
...
|-------|----------|--------|--------------|
| **Phase 0** | July 2026 | ✅ Complete | Parts 1 and 4–13 delivered; Conformance Adapter slots 1–4 bound |
| **Phase 1** | August 2026 | ✅ Complete | Part 14 SR/SBOM/VDR; Adapter SR slot bound; KSI-011–014 → active |
| **Phase 2** | Sep–Oct 2026 | ✅ Complete | OSCAL Emitter AR output; Part 15 PM governance artifacts; CR26 SR/PM rules |
| **Phase 3** | November 2026 | ✅ Complete | Part 16 PT/PII templates; Part 17 AT training program; KSI-022 → active; all 29 CR26 KSIs evaluable |
...
| **Phase 5** | January 2027 | ✅ Complete | FedRAMP 20x mandatory deadline; All 18 books operational; Continuous monitoring cadence established |
...
| PII mapping | Purview Data Map + sensitivity label lineage (extends Part 11) |
| PM metrics | Sentinel workbook for AU/CA/PM KPI dashboard (extends Part 12) |
...
| [Book 04 — From Mainframe to Application-Aware Modernization](Book_04_Federal_Application_Aware_Networking_Network_Modernization.qmd) | Part 4: Amazon Connect N8NN, Teams Phone, SD-WAN/SASE, G.114 compliance, DIA vs. SASE distinction |
| [Book 05 — Federal Telecommunications Modernization](Book_05_Federal_Application_Aware_Networking_Federal_Telecommunications_Modernization.qmd) | Part 5: AD-to-Entra migration, ZTNA, Active Governance control plane, FedRAMP 20x alignment |
| [Book 06 — SQL Server Authentication Modernization](Book_06_Federal_Application_Aware_Networking_SQL_Server_Authentication_Modernization.qmd) | Part 6: Arc Managed Identity, Kerberos/NTLM breakdown, login migration, application chain, NIST closure |
| [Book 07 — SQL Server Implementation Guide](Book_07_Federal_Application_Aware_Networking_SQL_Server_Implementation_Guide.qmd) | Part 7: 10-book runbook — estate discovery, Arc deployment, login migration, NTLM elimination, monitoring |
| [Book 08 — Database Consolidation and Network Physics](Book_08_Federal_Application_Aware_Networking_Database_Consolidation_Network_Physics.qmd) | Part 8: SSOT architecture, speed-of-light floor, SD-WAN for database traffic, consistency class alignment |
| [Book 09 — Privileged Access Management](Book_09_Federal_Application_Aware_Networking_Privileged_Access_Management.qmd) | Part 9: Entra PIM JIT activation, PAW architecture, AC-5/AC-6 least privilege, IA-11 re-authentication |
| [Book 10 — Vulnerability Management](Book_10_Federal_Application_Aware_Networking_Vulnerability_Management.qmd) | Part 10: Defender VM, CISA KEV integration, RA-5 continuous scanning, SI-2 flaw remediation |
| [Book 11 — Data Protection (Purview + Key Vault CMK)](Book_11_Federal_Application_Aware_Networking_Data_Protection_Purview.qmd) | Part 11: Purview DLP and sensitivity labels, Key Vault CMK, MP-2–5, SC-12/13/17/28, AU-10 |
| [Book 12 — SIEM / XDR / Detection Engineering](Book_12_Federal_Application_Aware_Networking_SIEM_XDR_Detection.qmd) | Part 12: Microsoft Sentinel, Defender XDR, KQL analytics, SOAR playbooks, SI-4/AU-6/IR-4/6/8 |
| [Book 13 — Business Continuity](Book_13_Federal_Application_Aware_Networking_Business_Continuity.qmd) | Part 13: CP-2 through CP-8 contingency planning, DR runbooks, Azure Site Recovery |
| [Book 14 — Supply Chain Risk Management](Book_14_Federal_Application_Aware_Networking_Supply_Chain_Risk_Management.qmd) | Part 14: Syft CycloneDX SBOM pipeline, Grype VDR/VEX, GitHub Actions BOD 26-04 gate, SR-family closure |
| [Book 15 — Program Management and Governance](Book_15_Federal_Application_Aware_Networking_Program_Management_Governance.qmd) | Part 15: ISPP template, POA&M tracker, SCRM Charter, Leadership RACI matrix, PM-family closure |
| [Book 16 — PII Processing and Transparency](Book_16_Federal_Application_Aware_Networking_PII_Processing_Transparency.qmd) | Part 16: Privacy Program Plan, authority-to-process templates, SORN/PIA scaffolding, Purview Data Map, PT-family closure |
| [Book 17 — Cybersecurity Awareness and Training](Book_17_Federal_Application_Aware_Networking_Cybersecurity_Training_Awareness.qmd) | Part 17: AT-2/AT-3/AT-4 training program, role-based matrices for six tiers, LMS evidence schema, CP-3 tabletop calendar, IR-2 drill documentation, KSI-022 activation |
| [Book 18 — Authorization Package and ConMon](Book_18_Federal_Application_Aware_Networking_Authorization_Package_ConMon.qmd) | Part 18: FedRAMP 20x authorization package structure, OSCAL AP+AR+POA&M bundle (29/29 satisfied), CA-7 ConMon program, BOD 26-04 VDR/VER submission, AO checklist, day-of-submission procedure |
