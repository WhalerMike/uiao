...
**The fifteen implementations described in this series are not optional modernization projects.** They are the structural prerequisites for operating at FedRAMP Moderate authorization under FedRAMP 20x rules, which are mandatory for all certified systems effective January 1, 2027.
:::
...
: Federal Application-Aware Networking Series — Books 00–15 {.striped .hover}
...
## NIST Control Closure — Parts 7–15
...
: Parts 7–15 — NIST SP 800-53 Rev 5 Control Coverage {.striped .hover}
...
KSI-022 (KSI-CED-RAT)**, the only remaining scaffold KSI — delivering the
machine-readable LMS training-effectiveness record that binds the AT family to the
Conformance Adapter and makes all 29 CR26 KSIs evaluable.
...
The fifteen-book series generates evidence. The **Conformance Adapter** is the
governance layer that maps evidence → control → KSI and produces the OSCAL
AP/AR/POAM artifact bundle that FedRAMP 20x evaluators ingest. Without it,
the AAN evidence exists but cannot be transmitted in the format evaluators
require.

**Current state:**

| Component | Status | Blocking Items |
|-----------|--------|----------------|
| Conformance Adapter schema | Defined | — |
| Surface slots 1–4 (IAM, Addressing, Network, Telemetry) | Bound to AAN evidence | — |
| Surface slots 5–6 (Endpoint, Security) | Phase 1 — Aug 2026 | — |
| OSCAL Emitter | Scaffold | Produces partial AP; no AR or POAM yet |
| KSI-011–014 (SR) | Scaffold | Requires Part 12 SR/SBOM artifacts |
...
2. KSI-011–014 require SR artifacts (VDR/VER) before bound rules can be authored
3. The OSCAL Emitter must be extended to produce AR (Assessment Results) with
   `satisfied`/`not-satisfied` status per KSI, not just AP (Assessment Plan)
...
|-------|----------|--------------|
| **Phase 0** | July 2026 | Parts 1–11 delivered; Conformance Adapter slots 1–4 bound |
| **Phase 1** | August 2026 | Part 12 SR/SBOM/VDR; Adapter SR slot bound; KSI-011–014 → active |
| **Phase 2** | Sep–Oct 2026 | OSCAL Emitter AR output; Part 13 PM governance artifacts; CR26 SR/PM rules |
| **Phase 3** | November 2026 | Part 14 PT/PII templates; Part 15 AT training program; KSI-022 → active; all 29 CR26 KSIs evaluable |
| **Phase 4** | December 2026 | BOD 26-04 VDR/VER submission (Dec 7); Authorization package filed; First complete OSCAL AP+AR+POAM bundle |
| **Phase 5** | January 2027 | FedRAMP 20x mandatory deadline; All 15 books operational; Continuous monitoring cadence established |

: Phased Delivery Roadmap — Phase 0 through Phase 5 {.striped .hover}
...
| [Book 02 — From Mainframe to Application-Aware Modernization](Book_02_Federal_Application_Aware_Networking_Network_Modernization.qmd) | Part 2: Amazon Connect N8NN, Teams Phone, SD-WAN/SASE, G.114 compliance, DIA vs. SASE distinction |
| [Book 03 — Federal Telecommunications Modernization](Book_03_Federal_Application_Aware_Networking_Federal_Telecommunications_Modernization.qmd) | Part 3: AD-to-Entra migration, ZTNA, Active Governance control plane, FedRAMP 20x alignment |
| [Book 04 — SQL Server Authentication Modernization](Book_04_Federal_Application_Aware_Networking_SQL_Server_Authentication_Modernization.qmd) | Part 4: Arc Managed Identity, Kerberos/NTLM breakdown, login migration, application chain, NIST closure |
| [Book 05 — SQL Server Implementation Guide](Book_05_Federal_Application_Aware_Networking_SQL_Server_Implementation_Guide.qmd) | Part 5: 10-book runbook — estate discovery, Arc deployment, login migration, NTLM elimination, monitoring |
| [Book 06 — Database Consolidation and Network Physics](Book_06_Federal_Application_Aware_Networking_Database_Consolidation_Network_Physics.qmd) | Part 6: SSOT architecture, speed-of-light floor, SD-WAN for database traffic, consistency class alignment |
| [Book 07 — Privileged Access Management](Book_07_Federal_Application_Aware_Networking_Privileged_Access_Management.qmd) | Part 7: Entra PIM JIT activation, PAW architecture, AC-5/AC-6 least privilege, IA-11 re-authentication |
| [Book 08 — Vulnerability Management](Book_08_Federal_Application_Aware_Networking_Vulnerability_Management.qmd) | Part 8: Defender VM, CISA KEV integration, RA-5 continuous scanning, SI-2 flaw remediation |
| [Book 09 — Data Protection (Purview + Key Vault CMK)](Book_09_Federal_Application_Aware_Networking_Data_Protection_Purview.qmd) | Part 9: Purview DLP and sensitivity labels, Key Vault CMK, MP-2–5, SC-12/13/17/28, AU-10 |
| [Book 10 — SIEM / XDR / Detection Engineering](Book_10_Federal_Application_Aware_Networking_SIEM_XDR_Detection.qmd) | Part 10: Microsoft Sentinel, Defender XDR, KQL analytics, SOAR playbooks, SI-4/AU-6/IR-4/6/8 |
| [Book 11 — Business Continuity](Book_11_Federal_Application_Aware_Networking_Business_Continuity.qmd) | Part 11: CP-2 through CP-8 contingency planning, DR runbooks, Azure Site Recovery |
| [Book 12 — Supply Chain Risk Management](Book_12_Federal_Application_Aware_Networking_Supply_Chain_Risk_Management.qmd) | Part 12: Syft CycloneDX SBOM pipeline, Grype VDR/VEX, GitHub Actions BOD 26-04 gate, SR-family closure |
| [Book 13 — Program Management and Governance](Book_13_Federal_Application_Aware_Networking_Program_Management_Governance.qmd) | Part 13: ISPP template, POA&M tracker, SCRM Charter, Leadership RACI matrix, PM-family closure |
| [Book 14 — PII Processing and Transparency](Book_14_Federal_Application_Aware_Networking_PII_Processing_Transparency.qmd) | Part 14: Privacy Program Plan, authority-to-process templates, SORN/PIA scaffolding, Purview Data Map, PT-family closure |
| [Book 15 — Cybersecurity Awareness and Training](Book_15_Federal_Application_Aware_Networking_Cybersecurity_Training_Awareness.qmd) | Part 15: AT-2/AT-3/AT-4 training program, role-based matrices for six tiers, LMS evidence schema, CP-3 tabletop calendar, IR-2 drill documentation, KSI-022 activation |
