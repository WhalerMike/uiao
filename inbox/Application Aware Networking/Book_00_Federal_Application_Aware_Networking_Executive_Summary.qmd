...
|---|---|---|---|---|---|
| KSI-001..010 (10) | M365 baseline (IAM/MLA/CNA/SVC configuration surface) | Microsoft 365 GCC tenant configuration against the CISA SCuBA baseline | **Yes — ScuBAGear** | ScuBA adapter (no slot binding) | Validation phase (after Parts 1–6 make the baseline the natural steady state) |
...
![Implementation Sequencing — Path to FedRAMP 20x Mandatory Compliance by January 1 2027](figs/es-fig-04-sequencing-roadmap.png){fig-alt="Horizontal timeline from July 2026 to June 2027 with milestone circles showing Class A opens August 3 2026, Class B and C open August 31 2026, FedRAMP Ready ceases July 28 2026 in red, FedRAMP 20x mandatory January 1 2027 in red, new Rev5 certs cease June 11 2027 in red. Three track bars: Part 1 InfoBlox DDI spans full timeline, Part 6 SD-WAN plus SASE concurrent, Part 5 Entra ID plus ZTNA multi-phase. White background." width="100%"}
