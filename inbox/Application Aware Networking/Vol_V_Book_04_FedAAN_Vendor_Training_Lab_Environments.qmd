---
title: "Vol V Book 04 — Federal Application-Aware Networking — Vendor Training & Lab Environments"
...
The AAN reference stack is Microsoft-heavy (Entra, Defender, Sentinel, Purview,
...
|---|---|---|---|
| Cisco | [Cisco U.](https://u.cisco.com/) | Vol I Bk 02, 05 | SD-WAN (ENSDWI-track), ISE/802.1X NAC, enterprise routing; subscription with free tiers |
...
| BlueCat | [BlueCat Training](https://bluecatnetworks.com/services/training/) | Vol I Bk 01 | DDI learning paths for the BlueCat migration path covered by the UIAO adapter |
...
| SailPoint | [Identity University](https://www.sailpoint.com/university) | Vol I Bk 04 | Joiner-mover-leaver governance for the HRIT lifecycle; documented NERM boundary exception |
| Fortinet | [Fortinet Training Institute](https://training.fortinet.com/) | Vol I Bk 05, 06 | Free NSE-track courses; SASE/ZTNA modules |
| Palo Alto Networks | [Education services](https://www.paloaltonetworks.com/services/education) | Vol I Bk 05, 06 | SASE (Prisma-track) coursework where Palo Alto is the SASE vendor |
...
| AWS | [AWS Skill Builder](https://skillbuilder.aws/) | Vol I Bk 05, 06 | Amazon Connect training for the N8NN contact-center boundary exception |
...
| ServiceNow | [ServiceNow University](https://learning.servicenow.com/) | Vol III Bk 06 · Vol IV Bk 03 | ITSM/CMDB training — the incident-ticket and evidence-workflow side; UIAO ships a ServiceNow adapter |
...
|---|---|---|
| **Tier F — fixture** | Nothing but this repo and Python | You want the evidence-binding mechanics (slot YAML → `uiao oscal ksi-ar`) with no cloud footprint |
...
*Federal Application-Aware Networking — Vol V Book 04 of the series. Volume V is
