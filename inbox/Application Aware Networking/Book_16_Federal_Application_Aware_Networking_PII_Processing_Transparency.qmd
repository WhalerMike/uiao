...
- **Part 11 (Purview + Key Vault)** — established the technical data
  ...
  through auto-labeling rules defined in Part 11.
- **Part 15 (Program Management Governance)** — established the organizational
  ...
  The RACI defined in Part 15 §3 assigns Privacy Officer accountability across
  all PT controls.
...
**Linkage:** PT-1 is the privacy parallel to PM-1 (ISPP, Part 15 §2). The
...
as the ISPP. Cross-reference Part 15 §3 RACI for the Privacy Officer role.
...
follows. This integration (established in Part 11) enables automated enforcement
...
> Label" references the sensitivity label applied in Part 11.
...
> Purview sensitivity label (from Part 11), encryption requirement, access
...
|-------------|--------------------------|----------------------|----------------|---------------|
| SSN (full) | `Restricted-SSN` | AES-256 at rest; TLS 1.3 in transit; CMK-managed (Part 11 §4) | Role-based; least privilege; MFA required; no service account access | All reads and writes logged to Sentinel; 7-year retention |
...
> AZURE] must be on file. Reference Part 11 §5 for the Azure BAA status under
...
4. **Breach Response:** SSN exposure triggers OMB M-17-12 breach notification
   procedures; see the Breach Response SOP (reference Part 15 §5 for incident
...
Part 11 §6 established auto-labeling rules in Microsoft Purview. The following
...
Microsoft Purview Data Map lineage (Part 11 §3) provides automated discovery of
...
auto-labeling triggers on intake (Part 11 §6).
...
> Purview labeling and DLP (Part 11) *enforce* the purposes and categories those
...
*End of Part 16 — PII Processing and Transparency*

*Previous: [Part 15 — Program Management Governance](Book_15_Federal_Application_Aware_Networking_Program_Management_Governance.qmd)*
