...
1. **FedRAMP-authorized platform.** The ServiceNow instance carries an authorization commensurate with the identity-attributed compliance data it handles. The series scope parameter is FedRAMP Moderate; the platform is referred to as *FedRAMP-authorized* and is verified on the FedRAMP Marketplace at procurement.
