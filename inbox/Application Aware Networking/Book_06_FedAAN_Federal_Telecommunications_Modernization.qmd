...
One-way network latency: 80–110 ms (engineering estimate: ~50 ms coast-to-coast propagation plus inspection-stack and queuing overhead; validate with per-site measurement during discovery). G.114 network budget: 75 ms. **Over spec.** The citizen hears the degradation.
