...
|---|---|---|---|---|
| **ServiceNow Now Platform** (ITOM + CMDB) | FedRAMP Moderate (Government Community Cloud, JAB P-ATO) | Broadest CMDB capability; native Discovery across cloud APIs, VMware, network, and MDM; widely deployed across federal civilian agencies; full lifecycle, ownership, and relationship tracking | High cost; complexity of implementation; Discovery requires agent or network-based scanning agents in each environment | R-01 through R-15 (all, with proper configuration) |
