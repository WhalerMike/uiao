...
- `aws.ssa.gov` sub-zone — delegated to Cloud Infrastructure team (AWS)
- `azure.ssa.gov` sub-zone — delegated to Cloud Infrastructure team (Azure)
- `oci.ssa.gov` sub-zone — delegated to Cloud Infrastructure team (OCI)
- `onprem.ssa.gov` sub-zone — delegated to on-premises Network Infrastructure team
- `apps.ssa.gov` sub-zone — delegated to Application Development / DevOps
