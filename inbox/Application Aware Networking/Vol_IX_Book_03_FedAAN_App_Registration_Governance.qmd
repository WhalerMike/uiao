...
| **4. Rotate** | Automated rotation before expiry; the app never depends on a human remembering | IA-5(2) |
...
| IA-5(2) | Public Key-Based Authentication | App-registration credentials issued as short-lived certs (ACME) with mandatory expiry and automated rotation â€” no long-lived secrets in config | FedRAMP Moderate | NIST SP 800-53 Rev 5; EO 14028 | Identity | KSI-IAM | No |
