...
**Artifact 3 — Communication Templates:** Pre-drafted notification templates for: initial internal escalation, agency leadership notification, US-CERT/CISA notification per OMB M-20-04 (1-hour reporting requirement for major incidents), and external disclosure (if required). Templates reduce response time under pressure and ensure legally required notification elements are included without drafting under stress.
