...
**your** artifact — the same bar as the UIAO substrate's Operator track ("clean
walker/drift run"), applied to the AAN vertical. Score the result against Vol V
Book 03's rubric ladder.

![The Track B capstone — one module, evidence-complete](figs/vol5b02-fig-02-capstone-one-module.png){#fig-vol5b02-02 fig-alt="A three-panel numbered diagram describing the implementation-track capstone. Panel 1, Implement end-to-end: pick one module from B1 through B8 and build or lab-simulate it fully; tagged 'B1–B8.' Panel 2, Land and regenerate: place the artifact where the slot binds it, then run uiao ksi evaluate and uiao oscal ksi-ar; tagged 'ksi-ar.json.' Panel 3, Your artifact, your verdict: the Assessment Results must show your module's slot verdict fed by your artifact — the same bar as the UIAO substrate's Operator track; tagged 'Scored in Bk 03.' A footer banner pairs each B-module with its A-module: B1 with A2, B2 with A1/A5, B3 with A1/A3, B4 with A1, B5 with A1/A5, B6 with A4/A6, B7 with A6/A7, and B8 with A8. White background. Source: Vol V Book 02 The Implementation Track briefing deck, Date Code 2026-07-09 17:00 ET." width="100%"}
