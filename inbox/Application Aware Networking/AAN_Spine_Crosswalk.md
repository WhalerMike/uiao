...
> **Generated file — do not hand-edit.** Produced by `render_crosswalk.py` from `aan-compliance-spine.yml`. Regenerate when closures change; CI-gated by `aan-authorities-drift.yml`.
...
| AU-2 | Event Logging | AU | Vol VIII Bk 07, Vol IX Bk 04 | KSI-MLA |
...
| CA-7 | Continuous Monitoring | CA | Vol III Bk 07, Vol VII Bk 02, Vol VII Bk 04 | KSI-MLA |
| CM-2 | Baseline Configuration | CM | Vol III Bk 03, Vol IX Bk 02 | KSI-CMT |
| CM-3 | Configuration Change Control | CM | Vol VII Bk 01, Vol VIII Bk 07, Vol IX Bk 02, Vol IX Bk 04 | KSI-CMT |
...
| SC-17 | Public Key Infrastructure Certificates | SC | Vol IX Bk 03 | KSI-IAM |
