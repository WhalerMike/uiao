...
Parts 1–9 deploy Entra ID authentication — Managed Identity tokens, Conditional Access, Entra-native OS login. These controls verify identity quality. They do not reduce role scope.
...
This is the boundary between authentication-only security (what Parts 1–9 deliver) and device-bound security (what the PAW delivers): the device itself is an additional authentication factor for privileged actions.
...
: NIST SP 800-53 Rev 5 control closure for Part 10 — Privileged Access Management {.striped .hover}
