...
![Authorization Package Structure](figs/ato-fig-01-package-structure.png){fig-alt="Hierarchical diagram of the authorization package for SSA GCC Moderate. Top tier: Authorization Package submitted to FedRAMP PMO with System Security Plan (SSP), Security Assessment Report (SAR), Plan of Action and Milestones (POA&M), and Authorization Decision. Second tier: OSCAL Machine-Readable Bundle — AP (Assessment Plan, 10 themes, 29 CR26 KSIs), AR (Assessment Results, 29 findings, 0 open risks, 8 evidence slots), POA&M (0 items, all KSIs satisfied). Third tier: AAN Evidence Layer — Books 1 through 18 providing infrastructure, security, governance, and training artifacts. Bottom tier: Continuous Monitoring Program — monthly OSCAL AR refresh, quarterly KSI review, annual full assessment, and ConMon dashboard via Sentinel." width="100%"}

> **Correction (2026-07 review — figure pending regeneration):** the figure's
> top tier reads "submitted to FedRAMP PMO." That framing is a category error
> for this system type: SSA is a consuming agency, and the package is
> **presented to the SSA Authorizing Official for the RMF authorization
> decision**, with inherited FedRAMP CSO authorizations documented as leveraged
> controls. The package contents (SSP, SAR, POA&M, OSCAL bundle) are correct as
> drawn — SSP/SAR/POA&M *is* the RMF package; only the submission target
> changes.
