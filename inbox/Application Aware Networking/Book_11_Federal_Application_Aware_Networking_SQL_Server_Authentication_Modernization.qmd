---
title: "Book 11 — Federal Application-Aware Networking: SQL Server Authentication Modernization"
...
::: {.callout-important}
**Series Context** — This document is Part 11 of the Federal Application-Aware Networking series. Parts 1–3 cover Landing Zone IPAM/DDI/PKI, Telecommunications Modernization, and Network Modernization. This part addresses the authentication layer of SQL Server — the protocol, credential, and identity surface that persists after network controls are in place.
:::
