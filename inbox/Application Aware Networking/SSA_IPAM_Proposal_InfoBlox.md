...
- Landing-zone / IPAM analysis and the 16-control mapping: `inbox/Application Aware Networking/SSA_Landing_Zone_IPAM_FedRAMP.md` and `Vol_I_Book_01_FedAAN_SSA_Landing_Zone_IPAM_FedRAMP.qmd`.
- Control-closure necessity (SC-20/21/22, CM-8): the series compliance spine, `inbox/Application Aware Networking/aan-compliance-spine.yml`.
