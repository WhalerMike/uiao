...
Draft. Teams Phone, SBC, Direct Routing, Operator Connect, and the SCuBA Teams baseline are deployed examples; the governed-catalog + SCuBA-drift-into-the-loop discipline is the invariant. The figure above is authored as committed house-style SVG per ADR-093, rendered to PNG at 3× for crisp `.docx` zoom.
