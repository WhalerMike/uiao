...
Draft. ServiceNow, Microsoft Graph, and Azure Resource Graph are deployed examples of the connector mechanism; the reconcile-to-the-naming-plane discipline is the invariant. Vendor claims cite vendor documentation. House-style figures per ADR-093 are added in the PPTX→DOCX sync pass; this draft is text-and-table-first.
