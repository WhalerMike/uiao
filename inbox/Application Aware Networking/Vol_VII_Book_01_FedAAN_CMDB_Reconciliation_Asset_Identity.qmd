...
Draft. ServiceNow, Microsoft Graph, and Azure Resource Graph are deployed examples of the connector mechanism; the reconcile-to-the-naming-plane discipline is the invariant. Vendor claims cite vendor documentation. The reconciliation-model figure is authored as committed house-style SVG (rasterized to PNG).
