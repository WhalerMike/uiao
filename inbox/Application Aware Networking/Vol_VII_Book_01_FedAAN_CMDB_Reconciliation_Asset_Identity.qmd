---
title: "Vol VII Book 01 — Federal Application-Aware Networking — CMDB Reconciliation & Asset Identity"
...
- **Vol I Book 01** — the authoritative IPAM/DDI identity this book reconciles to (the CM-8 SSOT).
...
Draft. ServiceNow, Microsoft Graph, and Azure Resource Graph are deployed examples of the connector mechanism; the reconcile-to-the-naming-plane discipline is the invariant. Vendor claims cite vendor documentation. The reconciliation-model figure is authored as committed house-style SVG per ADR-093 (rasterized to PNG).
