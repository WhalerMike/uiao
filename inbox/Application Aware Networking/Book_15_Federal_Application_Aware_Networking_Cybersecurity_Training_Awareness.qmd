...
```
┌─────────────────────────────────────────────────────────────────────┐
│              Federal AAN Cybersecurity Training Program              │
├──────────────────┬──────────────────┬──────────────────┬────────────┤
│  DIMENSION 1     │  DIMENSION 2     │  DIMENSION 3     │ DIMENSION 4│
│  General         │  Role-Based      │  Secure          │ IR/DR      │
│  Awareness       │  Specialized     │  Delivery        │ Training   │
│  (AT-2)          │  (AT-3)          │  (AT-3/SA-16)    │ (IR-2/CP-3)│
├──────────────────┼──────────────────┼──────────────────┼────────────┤
│  All employees   │  6 role tiers    │  Developers /    │ IR team /  │
│  Annual + phish  │  Role-specific   │  engineers /     │ recovery   │
│  simulation      │  curriculum      │  DevSecOps       │ personnel  │
├──────────────────┼──────────────────┼──────────────────┼────────────┤
│  LMS completion  │  LMS completion  │  Cert transcript │ Tabletop   │
│  record (AT-4)   │  by role (AT-4)  │  or course log   │ attendance │
└──────────────────┴──────────────────┴──────────────────┴────────────┘
```
