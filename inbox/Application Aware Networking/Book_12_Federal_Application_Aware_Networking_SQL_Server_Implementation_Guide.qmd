---
title: "Book 12 — Federal Application-Aware Networking: SQL Server Implementation Guide"
...
::: {.callout-important}
**Series Context** — This document is Part 12 of the Federal Application-Aware Networking series and the implementation companion to Part 4 (SQL Server Authentication Modernization). Part 4 covers the conceptual framework; this document provides the operational runbooks, command references, and configuration templates for execution.
:::
