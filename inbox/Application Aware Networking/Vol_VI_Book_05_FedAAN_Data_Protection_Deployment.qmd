...
4. Set the audit tier and export so retention meets the OMB M-21-31 event-logging tier and the Volume III audit-retention rationale (this is also the retention-cliff fix the detection layer depends on for long-tail forensics).
