---
title: "Vol I Book 02 — Federal Application-Aware Networking — Network Access Control: 802.1X and Device Identity"
...
```json
{
  ...
  "subjectAlternativeNameValue": "{{DeviceId}}@tenant.onmicrosoft.com",
  ...
  "scepServerUrls": ["https://ndes.tenant.onmicrosoft.com/certsrv/mscep/mscep.dll"]
}
```
