...
> integration.
>
> **Controlling precedent:** [ADR-002](../../../../src/uiao/canon/adr/adr-002-arc-entra-join-no-domain-join.md) — Arc-Enabled Servers Require Non-Domain-Joined State. This annex operates entirely within ADR-002's constraint and treats it as the day-zero target for net-new servers.
...
- [ADR-002 — Arc-Enabled Servers Require Non-Domain-Joined](../../../../src/uiao/canon/adr/adr-002-arc-entra-join-no-domain-join.md) (controlling precedent for server identity)
