...
for WHfB enrollment evidence. This gap is acknowledged in
[`surface-integration-plan.md`](../../surface-integration-plan.md)
§3 ("Explicitly out of scope — Windows Hello for Business as its
own adapter family") and deferred.
...
patterns" and [`surface-integration-plan.md`](../../surface-
integration-plan.md) §5.
