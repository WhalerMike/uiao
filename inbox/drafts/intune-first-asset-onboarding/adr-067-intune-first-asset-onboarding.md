...
impact: Establishes new doctrine for `src/uiao/modernization/directory-migration/adapters/device-management/intune-native/`; complements ADR-001 (HAADJ deprecation), ADR-002 (Arc non-domain-join), ADR-038 (device-plane OrgPath)
supersedes: null
superseded_by: null
...
**PROPOSED** — drafted 2026-05-13

> **Note on numbering:** ADR-067 is the next-available number as of
> 2026-05-13. The registry steward assigns the final number at
> promotion; this draft uses 067 as a placeholder and will be renumbered
> if other PRs land first.
...
- This bundle's accompanying documents:
  [`README.md`](README.md),
  [`doctrine.md`](doctrine.md),
  [`process.md`](process.md),
  [`procurement-handoff.md`](procurement-handoff.md),
  [`platforms/windows-autopilot.md`](platforms/windows-autopilot.md),
  [`platforms/macos-abm-ade.md`](platforms/macos-abm-ade.md),
  [`platforms/mobile-ios-android.md`](platforms/mobile-ios-android.md),
  [`platforms/arc-managed-servers.md`](platforms/arc-managed-servers.md),
