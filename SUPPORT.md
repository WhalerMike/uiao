...
| Situation | Channel |
|---|---|
| **Security vulnerability** | [Private advisory](https://github.com/WhalerMike/uiao/security/advisories/new) — do NOT open a public issue. See [`SECURITY.md`](https://github.com/WhalerMike/uiao/blob/main/SECURITY.md). |
...
| **Contributing** | Read [`CONTRIBUTING.md`](https://github.com/WhalerMike/uiao/blob/main/CONTRIBUTING.md) first — it covers setup, commit convention, canon protocol, and adapter activation. |
...
- **Security issues:** 3 business days for acknowledgement, 7 for triage. See [`SECURITY.md`](https://github.com/WhalerMike/uiao/blob/main/SECURITY.md).
