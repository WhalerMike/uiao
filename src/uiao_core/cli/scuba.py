"""uiao_core.cli.scuba — Typer sub-application for the SCuBA→IR plane.
...
callers use:
    ...
    uiao scuba transform --input ./input/scuba/tenant-a.json \\
                             --out   ./output/ir/tenant-a.ir.json \\
                                                      ...
                                                      mounted by ``uiao_core.cli.app`` via ``app.add_typer()``.
                                                      """
...
def transform_cmd(
                  ...
                  the resulting IR evidence bundle to *--out*.
                      ...
                      A timestamped log file is written automatically to
                          ``<out_parent>/../logs/<timestamp>-scuba-transform.log``.
                              """
      from uiao_core.scuba.transform import transform_scuba_to_ir
    ...
    console.print(f"[green]✓[/green] IR written → {output_path}")
