...
class EnforcementResult:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "ir_object_id": self.ir_object_id,
            "state": self.state,
            ...
            "poam_action": self.poam_action,
            "sar_updated": self.sar_updated,
            "error": self.error,
