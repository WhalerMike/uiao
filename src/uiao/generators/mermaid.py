...
def build_mermaid_visuals(*args: object, **kwargs: object) -> Path:
    ...
    raise RuntimeError(
        "build_mermaid_visuals() has been removed. Use build_plantuml_visuals() from uiao.generators.plantuml."
    )
...
def render_mermaid_file(*args: object, **kwargs: object) -> Path | None:
    ...
    raise RuntimeError(
        "render_mermaid_file() has been removed. Use render_plantuml_file() from uiao.generators.plantuml."
    )
