...
from uiao.models.evidence import EvidenceArtifact, EvidenceBundle
...
class EvidenceBundler:
    ...
    def build_bundle_model(self) -> EvidenceBundle:
        """Return an :class:`~uiao.models.evidence.EvidenceBundle` for this set of artifacts."""
    ...
    def write_zip(
        ...
        with zipfile.ZipFile(out, "w", compression=zipfile.ZIP_DEFLATED) as zf:
            ...
            from uiao.evidence.linker import EvidenceLinker  # avoid circular at module level
