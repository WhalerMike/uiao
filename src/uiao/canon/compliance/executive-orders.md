...
| FedRAMP / cloud transition | Adapter Framework; Adapter Segmentation Overview (UIAO_003) | Cloud adapters are first-class UIAO objects tagged with their FedRAMP boundary attribute; the GCC-Moderate baseline for this repository is declared in every repository's `CLAUDE.md`. |
