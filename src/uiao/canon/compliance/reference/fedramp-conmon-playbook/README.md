...
- **§16.3 — ConMon deliverable cadence.** Monthly vulnerability scans, monthly POA&M updates, quarterly STIG compliance, annual 3PAO assessment — all cadences in `uiao-core/ARCHITECTURE.md` §16.3 derive from this playbook and require verification.
