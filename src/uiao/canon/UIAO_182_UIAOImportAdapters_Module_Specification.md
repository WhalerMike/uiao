...
- Input data validation and sanitization are documented as a control surface (`SI-10`), per [`compliance-mapping.qmd §7.3`](../../../docs/customer-documents/uiao-orgcomp-integration/09-compliance-mapping.qmd).
