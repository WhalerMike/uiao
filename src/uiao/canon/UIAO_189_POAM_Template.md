...
> **Status: Current — authoritative template.** FedRAMP-compliant POA&M format identified in [`compliance-mapping.qmd §7.1`](../../../docs/customer-documents/uiao-aan-integration/09-compliance-mapping.qmd) and tracked in [UIAO_184](UIAO_184_Gap_Closure_Register.md) (Workstream A). Addresses `CA-5`. It is the structured ledger of open control gaps and their remediation, and the document the SSP ([UIAO_185](UIAO_185_System_Security_Plan_Template.md) §6) and Incident Response Plan ([UIAO_186](UIAO_186_Incident_Response_Plan.md) §5) both feed into.
...
- [`compliance-mapping.qmd`](../../../docs/customer-documents/uiao-aan-integration/09-compliance-mapping.qmd) — `CA-5` gap analysis
