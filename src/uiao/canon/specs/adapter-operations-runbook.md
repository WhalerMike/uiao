...
python -m uiao.adapters.conformance_check
python -m uiao.adapters.conformance_check --json > report.json
python -m uiao.adapters.conformance_check --markdown --adapter=terraform
```
...
python -m uiao.adapters.conformance_check --adapter=terraform

# Run specific test file with verbose output
pytest tests/test_terraform_adapter.py -v --tb=long

# Generate JSON report for analysis
python -m uiao.adapters.conformance_check --json | python -m json.tool
```
