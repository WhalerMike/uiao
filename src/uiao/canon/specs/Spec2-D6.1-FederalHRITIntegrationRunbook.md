...
| **EHRI** | OPM | Government-wide HR / payroll / training data warehouse for analytics and policy | 5 U.S.C. §3301; OPM/GOVT-1 (General Personnel Records — expressly covers EHRI and the Central Employee Record; OPM/GOVT-7 is applicant demographic data and does not apply) | Downstream consumer; Privacy Act routine-use disclosures |
