...
> **Status: Current — authoritative template.** SCRM plan identified in [`compliance-mapping.qmd §7.1`](../../../docs/customer-documents/uiao-orgcomp-integration/09-compliance-mapping.qmd) and tracked in [UIAO_184](UIAO_184_Gap_Closure_Register.md) (Workstream A). Addresses `SR-1` through `SR-12`. Bracketed `[PLACEHOLDER]` fields are completed per authorizing agency.
...
- [`compliance-mapping.qmd`](../../../docs/customer-documents/uiao-orgcomp-integration/09-compliance-mapping.qmd) — `SR` gap analysis
