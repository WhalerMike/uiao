...
**ACCEPTED** — 2026-05-19. Locks in Option B (migration-only with exception-grant requirement). Companion canon at IFO_014 (`src/uiao/modernization/intune-first-onboarding/platforms/windows-surface.md`).
...
- **Con:** Compliance / transformation work is forced by external regime; open questions on device classes invite vendor pressure to resolve them in the vendor's favor.
...
|---|---|---|
| Microsoft Learn — Surface Hub 3 overview | https://learn.microsoft.com/en-us/surface-hub/surface-hub-3-overview | 2026-05-19 (canonical path; browser verification owed — see note below) |
| Microsoft Learn — Migrate Surface Hub 2S to Windows 10 Pro/Enterprise (image replacement to Windows 11 IoT Enterprise / MTR) | https://learn.microsoft.com/en-us/surface-hub/surface-hub-2s-migrate-to-windows-10-pro-enterprise | 2026-05-19 (canonical path; browser verification owed — see note below) |
| Microsoft Learn — Microsoft Teams Rooms Pro Management | https://learn.microsoft.com/en-us/microsoftteams/rooms/microsoft-teams-rooms-pro-management | 2026-05-19 (canonical path; browser verification owed — see note below) |
| ADR-001 — HAADJ Deprecated | [adr-001-haadj-deprecated-entra-join-only.md](adr-001-haadj-deprecated-entra-join-only.md) | 2026-05-19 |
| ADR-071 — Intune-First Asset Onboarding | [adr-071-intune-first-asset-onboarding.md](adr-071-intune-first-asset-onboarding.md) | 2026-05-19 |

> Microsoft Learn URLs are the canonical paths cited at authoring time. They could not be fetched from the CI / cloud environment where this ADR was promoted (Microsoft Learn returns HTTP 403 to unauthenticated cloud IPs — see `.lycheeignore`). Browser-based confirmation of page title and current content is owed at the next review trigger (Microsoft Ignite 2026, scheduled review).
...
- IFO_014 — Platform Annex for Microsoft Surface Endpoints ([../../modernization/intune-first-onboarding/platforms/windows-surface.md](../../modernization/intune-first-onboarding/platforms/windows-surface.md))
