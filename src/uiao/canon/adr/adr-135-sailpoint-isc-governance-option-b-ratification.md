...
- `docs/customer-documents/whitepapers/ticket-to-machine-not-ticket-to-human.qmd` §8/§11 — the customer-facing argument this ADR's binding supports; see also the companion OrgComp book this ADR enables.
