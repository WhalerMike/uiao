...
1. **This PR.** ADR lands in
   ...
   UIAO_129 + UIAO_130 land with it. Findings class
   infrastructure (`docs/findings/README.md` + `docs/findings/index.qmd`)
   lands alongside. The FedRAMP-INR instance lands in a follow-on
   PR with properly-cited Microsoft Learn + agency evidence.
...
4. **Canon update PRs.** The six canon updates in §4 land
   sequentially over the following weeks, each with its own test
   plan.

## Open questions

None blocking promotion of this ADR.
