...
# ADR-058: SailPoint NERM Adapter — Boundary-Exception Carve-Out and Slot Allocation
...
1. PR #1 (this ADR) — land `adr-058-sailpoint-adapter-family.md` plus
...
5. Update `src/uiao/canon/adr/index.md` to list ADR-058 under the
