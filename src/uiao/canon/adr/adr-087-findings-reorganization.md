...
A single in-place patch to [`src/uiao/canon/adr/adr-030-pre-uiao-terminology-reconciliation.md`](adr-030-pre-uiao-terminology-reconciliation.md) at the §5.2 paragraph:
...
|---|---|---|
| Canon ADRs | 4 | [adr-030](adr-030-pre-uiao-terminology-reconciliation.md), [adr-047](adr-106-fedramp-20x-integration.md), [adr-058](adr-058-microsoft-purview-conformance-adapter-coverage.md), [adr-061](adr-061-fedramp-cr26-catalog-vendoring.md) |
