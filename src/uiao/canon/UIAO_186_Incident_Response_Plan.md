...
> **Status: Current — authoritative template.** Standalone incident-response plan identified in [`compliance-mapping.qmd §7.1`](../../../docs/customer-documents/uiao-orgcomp-integration/09-compliance-mapping.qmd) and tracked in [UIAO_184](UIAO_184_Gap_Closure_Register.md) (Workstream A). Covers `IR-1` through `IR-8`. Bracketed `[PLACEHOLDER]` fields are completed per authorizing agency.
...
- [`compliance-mapping.qmd`](../../../docs/customer-documents/uiao-orgcomp-integration/09-compliance-mapping.qmd) — `IR-1`…`IR-8` gap analysis
