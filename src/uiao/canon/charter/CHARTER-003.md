...
| **Telemetry** | Centralized logging with identity, network, and application correlation. Automated threat detection and response. Shared telemetry with CISA (CDM/CLAW). Machine-speed incident response. (EO 14028 §6–8; CISA ZTMM Visibility & Analytics; OMB M-26-14) |
...
- **CISA Binding Operational Directives** (BOD 26-04 — which revoked BOD 22-01 and BOD 19-02 on 10 June 2026 — BOD 23-01, BOD 23-02, [BOD 25-01](https://cyber.dhs.gov/bod/25-01/)) are mandatory and enforceable. Non-compliance is reported to the National Cyber Director and OMB.
...
| **Telemetry / Log Data** | CISO / SOC | Generated by systems; ingested by Splunk/Sentinel | Retention per OMB M-26-14 (six months actively searchable, one year retrievable); tamper-evident storage; CDM/CLAW export; PII fields masked at ingestion |
