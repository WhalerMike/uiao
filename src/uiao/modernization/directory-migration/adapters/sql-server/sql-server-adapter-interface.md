...
- Forest-wide SPN enumeration for `MSSQLSvc/*` prefixes (see
  [`src/uiao/adapters/customer-documents/reference-architecture/active_directory/survey.py`](../../../../adapters/modernization/active_directory/survey.py)
...
- [`../../../../adapters/customer-documents/reference-architecture/active_directory/survey.py`](../../../../adapters/modernization/active_directory/survey.py) — `extract_spn_inventory()` implementation
