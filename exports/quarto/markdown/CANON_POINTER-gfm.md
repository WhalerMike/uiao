...
The UIAO Governance Canon — all human-readable documentation,
appendices, ADRs, diagrams, glossary, and onboarding guides — lives
exclusively in:
...
> Machine artifacts → `uiao-core` ONLY Human artifacts → `uiao-docs`
> ONLY No duplication across repos. This rule is non-negotiable.
