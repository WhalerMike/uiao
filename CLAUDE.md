# CLAUDE.md — UIAO Consolidated Monorepo

> Repo-root control surface for Claude Code / agent integration. Three per-module CLAUDE.md files (`core/CLAUDE.md`, `docs/CLAUDE.md`, `impl/CLAUDE.md`) exist for module-scoped context; this file is the substrate-level entry point.
