...
1. **[FORMAT-CANON.qmd](https://github.com/WhalerMike/uiao-docs/blob/main/docs/FORMAT-CANON.qmd)** — Absolute authority for file structure, naming conventions, casing, indentation, quoting, and styling. (Lives in `uiao-docs`.)
