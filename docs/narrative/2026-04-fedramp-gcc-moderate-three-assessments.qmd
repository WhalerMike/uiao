...
[FINDING-002](../findings/fedramp-gcc-moderate-thousandeyes-coverage-scope.qmd).
...
Microsoft actually applies the rule to GCC-Moderate's blocked
pipelines — filing a 20x-aligned package or opting into the **Rev5
Balance Improvement Releases** for the GCC-Moderate offering. The rule
itself is no longer hypothetical: MAS launched 2026-06-24 as part of
FedRAMP's Consolidated Rules for 2026 and became required for 20x
authorizations on 2026-07-04 (Rev5 optional adoption opened the same
date, required to obtain from 2027-01-01). Strategically: the
**negotiation surface** changes — agency requests for descoped telemetry
now have a named, live mechanism to point at, not a future one.
...
| Customer doc | [`B1-gcc-moderate-boundary-model.qmd`](../customer-documents/orgcomp-series/boundary/B1-gcc-moderate-boundary-model.qmd) | Boundary model leaf with ZTMM ceiling and compliance posture |
