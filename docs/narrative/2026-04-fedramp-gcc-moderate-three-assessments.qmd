...
[`src/uiao/adapters/customer-documents/reference-architecture/gcc_boundary_probe/`](../../src/uiao/adapters/customer-documents/reference-architecture/gcc_boundary_probe/);
...
| Customer doc | [`B1-gcc-moderate-boundary-model.qmd`](../customer-documents/federal-aan-series/boundary/B1-gcc-moderate-boundary-model.qmd) | Boundary model leaf with ZTMM ceiling and compliance posture |
