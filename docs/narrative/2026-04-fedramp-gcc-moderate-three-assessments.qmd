...
| Adapter | [`gcc_boundary_probe/sentinel_probe.py`](../../src/uiao/adapters/customer-documents/reference-architecture/gcc_boundary_probe/sentinel_probe.py) | KQL runner + §10.2 dashboard-completeness scorecard |
