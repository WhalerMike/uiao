...
subtitle: "The 17-book Federal AAN series as a FedRAMP 20x / NIST SP 800-53 Rev 5 compliance curriculum"
date: today
date-format: "MMMM D, YYYY"
description: "Compliance track of the AAN Training Program: nine modules (orientation plus the eight AAN evidence slots) that teach which controls each of the 17 AAN books closes, which FedRAMP 20x KSI category evaluates the closure, and how evidence flows through the UIAO conformance pipeline."
---
...
![Figure 1 — Track A at a glance: the books feeding each of the eight evidence slots, with KSI category and NIST anchor. The footer strip notes all-29-KSI evaluability and the Book 16 submission cadence.](figs/tp-fig-02-slot-book-matrix.png){fig-alt="Track A matrix: which books feed each of the eight evidence slots"}
...
- **Checkpoint:** write a one-page brief stating which control families the
  corpus closes today, which were structurally absent until Books 12–15
  (SR, PM, PT, AT), and how Book 16 assembles the AP/AR/POA&M package now
...
- **Evaluate:** **KSI-CMT** (configuration / change-management evidence);
  KSI-011–014 were activated by the Book 12 SBOM/VDR/VER evidence
  contract — the BOD 26-04 submission (December 7, 2026) remains the
  operational cadence Book 16 runs.
- **Checkpoint:** state the BOD 26-04 submission story: which SBOM artifacts
  Book 12 requires, which KSI rules they activated, and how the Book 16
...
- **Read:** Book 15 (Cybersecurity Training & Awareness). Book 16's
...
4. states the gap and its deadline for anything not-evaluated or stale
   (Book 16 defines per-slot evidence freshness rules).
