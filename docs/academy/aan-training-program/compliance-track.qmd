...
![Figure 1 — Track A at a glance: the books feeding each of the seven evidence slots, with KSI category and NIST anchor. The amber strip is the slot-6 BOD 26-04 gate.](figs/tp-fig-02-slot-book-matrix.png){fig-alt="Track A matrix: which books feed each of the seven evidence slots"}
