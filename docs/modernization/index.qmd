...
|--------|-----------|-------|-----------|
| **Identity Modernization** | MOD_xxx | User hierarchy, OrgPath attributes, dynamic groups, AUs, HR-driven lifecycle, delegation, Conditional Access | 28 files (UIAO_150 + A-Z) |
...
|-------|---------------|---------------|
| **Governance Layer** | Drift detection, enforcement testing, telemetry, SLA tracking, provenance | UIAO_163 (Drift Engine); UIAO_162 (SLA Heatmap); UIAO_174 (Telemetry) |
| **Policy Layer** | RBAC, Conditional Access, lifecycle workflows, delegation | UIAO_154 (Delegation Matrix); UIAO_161 (Decision Trees); UIAO_167 (Escalation) |
| **Structure Layer** | OrgPath attributes, dynamic groups, Administrative Units | UIAO_151 (Codebook); UIAO_152 (Dynamic Groups); UIAO_153 (Attribute Mapping) |
| **Identity Layer** | User accounts, group objects, service principals, extension attributes | UIAO_150 (Executive Summary); UIAO_156 (Migration Runbook) |
