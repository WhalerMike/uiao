...
All OrgTree source files are in the monorepo at [`src/uiao/modernization/orgtree/`](https://github.com/WhalerMike/uiao/tree/main/src/uiao/modernization/orgtree).
The document registry with full metadata is at [`src/uiao/modernization/orgtree/document-registry.yaml`](https://github.com/WhalerMike/uiao/blob/main/src/uiao/modernization/orgtree/document-registry.yaml).
