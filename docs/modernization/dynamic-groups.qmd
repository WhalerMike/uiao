...
`user.extensionAttribute1` (the OrgPath attribute defined in UIAO_151):
...
| **Membership Drift** | Unexpected member count — root cause is OrgPath values (UIAO_151) | MEDIUM | Fix at source |
...
4. **Governed changes only** — additions/modifications follow UIAO_155 Workflow 3

::: {.callout-tip}
## Source
Full canonical definitions with PowerShell validation scripts:
`src/uiao/canon/UIAO_152_Dynamic_Group_Library.md`
:::