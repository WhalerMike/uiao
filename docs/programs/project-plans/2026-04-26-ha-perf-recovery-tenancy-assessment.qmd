...
| 119.3 (a) | UIAO_119 v2 — feature-flag system (model, registry, canon, walker hygiene) | Substrate maintainer | After 119.1 | ✅ shipped 2026-04-26 — see [v2 feature-flag impl](2026-04-26-uiao_119-v2-feature-flags.qmd) |
| 119.3 (b) — wave 1 | Wire `epl.action.block.enabled` (BlockHandler) and `data-lake.immutable.strict` (FilesystemArchive) feature-flag check-points | Substrate maintainer | After 119.3 (a) | ✅ shipped 2026-04-26 — see [check-point wiring impl](2026-04-26-uiao_119-checkpoint-wiring.qmd) |
| 119.3 (b) — wave 2 (CLI half) | Wire `tenancy.environment.prod-promote` into a CLI consumer | Substrate maintainer | After CLI promote subcommand lands | ✅ shipped 2026-04-26 — see [`uiao tenant promote-preview`](2026-04-26-uiao_119-cli-tenant-promote.qmd) |
| 119.3 (b) — wave 2 (CQL half) | Wire `auditor-api.cql.experimental-ops` once CQL gains experimental operators | Substrate maintainer | After CQL v2 ops land | ✅ shipped 2026-04-26 — see [CQL experimental ops impl](2026-04-26-uiao_119-cql-experimental-ops.qmd) |
| 119.3 (b) — wave 3 | Wire orchestrator plane selection through the flag system (UIAO_100 scheduler) | Substrate maintainer | After orchestrator optional-plane registry | ✅ shipped 2026-04-26 — see [orchestrator plane-flags impl](2026-04-26-uiao_119-orchestrator-plane-flags.qmd) |
| 119.3 (c) | Migration sandbox — clone `TenantContext`, run pipeline, snapshot outputs, emit diff report | Substrate maintainer | After 119.3 (a) | ✅ shipped 2026-04-26 — see [migration sandbox impl](2026-04-26-uiao_119-migration-sandbox.qmd) |
| 119.4 | Wire tenant + environment tagging into EnforcementJournal records and ArchiveEntry extras | Substrate maintainer | After 119.3 (a) | ✅ shipped 2026-04-26 — see [tagging wire-up impl](2026-04-26-uiao_119-journal-tagging.qmd) |
| 119.5 | Document the canary → standard → regulated rollout flow as a UIAO_124 Adapter Ops Runbook entry once the feature-flag check-points land | Substrate maintainer | After 119.3 (b) | ✅ shipped 2026-04-26 — see [UIAO_119 canary rollout runbook](../ops-runbook/2026-04-26-uiao_119-canary-rollout.qmd) (shipped early; waves 2+3 don't change the procedure shape) |
...
| UIAO_119 | ⚠️ aspirational | 🟡 working — **all action items ✅ shipped 2026-04-26**: [v1](2026-04-26-uiao_119-v1-data-layer.qmd), [v2](2026-04-26-uiao_119-v2-feature-flags.qmd), [tagging](2026-04-26-uiao_119-journal-tagging.qmd), [check-points](2026-04-26-uiao_119-checkpoint-wiring.qmd), [API filter](2026-04-26-uiao_119-auditor-api-tenant-filter.qmd), [sandbox](2026-04-26-uiao_119-migration-sandbox.qmd), [runbook](../ops-runbook/2026-04-26-uiao_119-canary-rollout.qmd), [plane flags](2026-04-26-uiao_119-orchestrator-plane-flags.qmd), [CLI promote](2026-04-26-uiao_119-cli-tenant-promote.qmd), [CQL experimental ops](2026-04-26-uiao_119-cql-experimental-ops.qmd) |
