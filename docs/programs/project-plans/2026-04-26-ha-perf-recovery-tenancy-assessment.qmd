...
| # | Action | Owner | Due |
|---|---|---|---|
| 119.1 | Open a UIAO_119 implementation PR per the work-item breakdown above | Substrate maintainer | Next sprint |
| 119.2 | Add `tenant_class` and `environment` to `tenants.yaml` schema + walker hygiene | Substrate maintainer | Within 119.1 |
| 119.3 | Document the canary → standard → regulated rollout flow as a UIAO_124 Adapter Ops Runbook entry once the feature-flag system lands | Substrate maintainer | After 119.1 |
...
| UIAO_119 | ⚠️ aspirational | ⚠️ aspirational — **scheduled for next sprint** (~2.5 weeks scope) per assessment |
