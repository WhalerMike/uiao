...
|---|---|---|---|---|
| 117.1 | Schedule Phase 1 (Raw-Zone immutability + checkpoint label + manual SOP) as a UIAO_127 sub-plan | Substrate maintainer | Next sprint | ✅ shipped 2026-04-26 — see [Phase 1 implementation record](2026-04-26-uiao_117-phase1-recovery.html) |
...
| # | Action | Owner | Due | Status |
|---|---|---|---|---|
| 119.1 | UIAO_119 v1 data layer — `TenantClass` + `Environment` enums; `tenant_class` field on `Tenant`; `environment` on `TenantContext`; tagging helper | Substrate maintainer | Next sprint | ✅ shipped 2026-04-26 — see [v1 data layer impl](2026-04-26-uiao_119-v1-data-layer.html) |
...
| 119.3 (a) | UIAO_119 v2 — feature-flag system (model, registry, canon, walker hygiene) | Substrate maintainer | After 119.1 | ✅ shipped 2026-04-26 — see [v2 feature-flag impl](2026-04-26-uiao_119-v2-feature-flags.html) |
| 119.3 (b) — wave 1 | Wire `epl.action.block.enabled` (BlockHandler) and `data-lake.immutable.strict` (FilesystemArchive) feature-flag check-points | Substrate maintainer | After 119.3 (a) | ✅ shipped 2026-04-26 — see [check-point wiring impl](2026-04-26-uiao_119-checkpoint-wiring.html) |
...
| 119.3 (b) — wave 2 (CQL half) | Wire `auditor-api.cql.experimental-ops` once CQL gains experimental operators | Substrate maintainer | After CQL v2 ops land | ✅ shipped 2026-04-26 — see [CQL experimental ops impl](2026-04-26-uiao_119-cql-experimental-ops.html) |
| 119.3 (b) — wave 3 | Wire orchestrator plane selection through the flag system (UIAO_100 scheduler) | Substrate maintainer | After orchestrator optional-plane registry | ✅ shipped 2026-04-26 — see [orchestrator plane-flags impl](2026-04-26-uiao_119-orchestrator-plane-flags.html) |
| 119.3 (c) | Migration sandbox — clone `TenantContext`, run pipeline, snapshot outputs, emit diff report | Substrate maintainer | After 119.3 (a) | ✅ shipped 2026-04-26 — see [migration sandbox impl](2026-04-26-uiao_119-migration-sandbox.html) |
| 119.4 | Wire tenant + environment tagging into EnforcementJournal records and ArchiveEntry extras | Substrate maintainer | After 119.3 (a) | ✅ shipped 2026-04-26 — see [tagging wire-up impl](2026-04-26-uiao_119-journal-tagging.html) |
| 119.5 | Document the canary → standard → regulated rollout flow as a UIAO_124 Adapter Ops Runbook entry once the feature-flag check-points land | Substrate maintainer | After 119.3 (b) | ✅ shipped 2026-04-26 — see [UIAO_119 canary rollout runbook](../ops-runbook/2026-04-26-uiao_119-canary-rollout.html) (shipped early; waves 2+3 don't change the procedure shape) |
...
| Row | From | To |
|---|---|---|
| UIAO_114 | ⚠️ aspirational (no notes) | ⚠️ aspirational — **deferred to Phase 2** per [this assessment](../project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.html) |
| UIAO_115 | ⚠️ aspirational | ⚠️ aspirational — **deferred pending baseline** per assessment |
| UIAO_117 | ⚠️ aspirational | 🟡 working — **Phase 1 ✅ shipped 2026-04-26** ([impl record](2026-04-26-uiao_117-phase1-recovery.html)); Phase 2 deferred to first regulated-tenant engagement |
| UIAO_119 | ⚠️ aspirational | 🟡 working — **all action items ✅ shipped 2026-04-26**: [v1](2026-04-26-uiao_119-v1-data-layer.html), [v2](2026-04-26-uiao_119-v2-feature-flags.html), [tagging](2026-04-26-uiao_119-journal-tagging.html), [check-points](2026-04-26-uiao_119-checkpoint-wiring.html), [API filter](2026-04-26-uiao_119-auditor-api-tenant-filter.html), [sandbox](2026-04-26-uiao_119-migration-sandbox.html), [runbook](../ops-runbook/2026-04-26-uiao_119-canary-rollout.html), [plane flags](2026-04-26-uiao_119-orchestrator-plane-flags.html), [CLI promote](2026-04-26-uiao_119-cli-tenant-promote.html), [CQL experimental ops](2026-04-26-uiao_119-cql-experimental-ops.html) |
