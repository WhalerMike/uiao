...
| 119.5 | Document the canary → standard → regulated rollout flow as a UIAO_124 Adapter Ops Runbook entry once the feature-flag check-points land | Substrate maintainer | After 119.3 (b) | open |
...
| UIAO_119 | ⚠️ aspirational | 🟡 working — **v1 + v2 + tagging + check-points + API filter + migration sandbox ✅ shipped 2026-04-26** ([v1](2026-04-26-uiao_119-v1-data-layer.qmd), [v2](2026-04-26-uiao_119-v2-feature-flags.qmd), [tagging](2026-04-26-uiao_119-journal-tagging.qmd), [check-points](2026-04-26-uiao_119-checkpoint-wiring.qmd), [API filter](2026-04-26-uiao_119-auditor-api-tenant-filter.qmd), [sandbox](2026-04-26-uiao_119-migration-sandbox.qmd)); 119.3 (b) waves 2+3 + 119.5 ops runbook open |
