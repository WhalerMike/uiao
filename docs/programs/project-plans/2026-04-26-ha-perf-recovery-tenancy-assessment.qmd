...
| # | Action | Owner | Due |
|---|---|---|---|
| 117.1 | Schedule Phase 1 (Raw-Zone immutability + checkpoint label + manual SOP) as a UIAO_127 sub-plan | Substrate maintainer | Next sprint |
| 117.2 | Hold Phase 2 until first regulated-tenant engagement | Partner agency + substrate maintainer | Phase 2 kickoff |
...
| UIAO_117 | ⚠️ aspirational | ⚠️ aspirational — **Phase 1 scheduled, Phase 2 deferred** per assessment |
