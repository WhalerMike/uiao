...
The order matters because effort is finite and the 2027-04-01 deadline is fixed. Migrating the logins of an instance to Entra ID, only to retire that instance three months later, is wasted work measured against a deadline that does not move. The SQL Server engine-authentication decision makes the sequencing normative: the consolidation assessment classifies every instance **retain**, **consolidate**, or **retire** before any login is touched.
