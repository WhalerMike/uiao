...
**[sql-server-narrative-standalone-bundle.docx](sql-server-narrative-standalone-bundle.docx)** — every page in this section concatenated into one Word document. Regenerated on every site deploy.
:::
