...
![Technical architecture diagram showing the AODIM attribute flow: HR System...](images/aodim-architecture-image-01-technical-architecture-diagram-s.png){#fig-aodim-architecture-image-01 fig-alt="Technical architecture diagram showing the AODIM attribute flow: HR System..." width="85%"}
...
![Side-by-side comparison diagram: Left panel labeled 'Legacy OU-Based...](images/aodim-architecture-image-02-side-by-side-comparison-diagram.png){#fig-aodim-architecture-image-02 fig-alt="Side-by-side comparison diagram: Left panel labeled 'Legacy OU-Based..." width="85%"}
...
![Operational flow diagram showing the AODIM runtime cycle: Identity Event...](images/aodim-architecture-image-03-operational-flow-diagram-showing.png){#fig-aodim-architecture-image-03 fig-alt="Operational flow diagram showing the AODIM runtime cycle: Identity Event..." width="85%"}
