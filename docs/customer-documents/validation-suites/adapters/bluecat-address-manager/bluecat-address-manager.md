---
title: "AVS — BlueCat Address Manager (BAM)"
...
# Adapter Validation Suite — BlueCat Address Manager (BAM)
...
- Tier 2 contract fixtures: `tests/fixtures/contract/bluecat-address-manager/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_bluecat_address_manager_adapter.py`
