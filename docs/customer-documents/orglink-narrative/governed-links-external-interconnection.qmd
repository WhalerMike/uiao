---
title: "Governed Links: External Interconnection, the Federal Identity Mesh, and SSOT with Due Process"
subtitle: "UIAO OrgLink — the external interaction plane · first narrative work"
date: 2026-07-25
---
...
First published work of the **OrgLink** pillar (elevated by ADR-134; object
class per [`UIAO_145`](https://github.com/WhalerMike/uiao/blob/main/src/uiao/canon/specs/UIAO_145_link-object-class.md),
doctrine per [`ADR-132`](../../adr/adr-132-orglink-link-object-class.qmd)).
Statistics verified against the cited GAO sources at publication
(2026-07-25) and re-verified at the pillar's review cadence.
:::
...
The integrity case is quantitative. Federal agencies reported an
estimated [$162 billion in improper payments for fiscal year 2024](https://www.gao.gov/products/gao-25-107753)
and [$186 billion for fiscal year 2025](https://www.gao.gov/products/gao-26-108694),
with [cumulative estimates of about $2.8 trillion since fiscal year 2003](https://www.gao.gov/blog/federal-government-made-estimated-162-billion-improper-payments-last-fiscal-year)
— and GAO notes the true totals are likely higher. Pandemic-era
unemployment-insurance fraud alone is [GAO-estimated at $100–135 billion](https://www.gao.gov/products/gao-23-106696),
roughly 11–15% of UI benefits paid during the period.
