...
repo-path: docs/customer-documents/uiao-orgcomp-integration/13-master-document-spec.qmd
...
aliases:
  - /customer-documents/uiao-aan-integration/13-master-document-spec.html
  - /customer-documents/compliance/governance-canon/master-document-spec.html
...
\![A 16:9 muted-blue schematic showing the SSOT boundary, four adapter classes...](images/master-document-spec-diagram-07-a-169-muted-blue-schematic-showi.png){#fig-master-document-spec-diagram-07 fig-alt="A 16:9 muted-blue schematic showing the SSOT boundary, four adapter classes..." width="100%"}
...
\![A muted-blue shield icon representing SSOT+Identity+Security with four inbound...](images/master-document-spec-image-05-a-muted-blue-shield-icon-represe.png){#fig-master-document-spec-image-05 fig-alt="A muted-blue shield icon representing SSOT+Identity+Security with four inbound..." width="100%"}
