...
repo-path: docs/customer-documents/uiao-orgcomp-integration/09-compliance-mapping.qmd
...
aliases:
  - /customer-documents/uiao-aan-integration/09-compliance-mapping.html
  - /customer-documents/compliance/controls-testing/compliance-mapping.html
family: uiao-orgcomp-integration

---

![NIST 800-53 family coverage heatmap](images/compliance-mapping-image-01-nist-800-53-family-coverage-heat.png){#fig-compliance-mapping-image-01 fig-alt="NIST 800-53 family coverage heatmap. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="100%"}

![framework-to-document traceability matrix](images/compliance-mapping-image-02-framework-to-document-traceabili.png){#fig-compliance-mapping-image-02 fig-alt="framework-to-document traceability matrix. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="100%"}

![gap-remediation roadmap timeline](images/compliance-mapping-image-03-gap-remediation-roadmap-timeline.png){#fig-compliance-mapping-image-03 fig-alt="gap-remediation roadmap timeline. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="100%"}
...
- **CISA Binding Operational Directives** --- BOD 26-04 (risk-based remediation, revoking BOD 22-01 and BOD 19-02), BOD 23-01 (Asset Visibility), [BOD 25-01](https://cyber.dhs.gov/bod/25-01/) (SCuBA/M365 Baselines)
...
BOD 22-01 --- Reducing the Significant Risk of Known Exploited Vulnerabilities (REVOKED 2026-06-10 by BOD 26-04)
...
|                                                                                                                                                                                                           |
| **BOD 26-04 Alignment (KEV variable):** ESC1-ESC8 vulnerability detection directly addresses BOD 26-04 by identifying known exploitable PKI misconfigurations that may appear in the KEV catalog.                        |
|                                                                                                                                                                                                           |
...
|                                                                                                                                                                                                                |
| **BOD 26-04 Alignment (KEV variable):** ESC1-ESC8 detection identifies known exploitable conditions that may correspond to KEV catalog entries.                                                                               |
|                                                                                                                                                                                                                |
...
5.1 BOD 26-04 --- Risk-Based Remediation (KEV listing is one of four variables; revoked BOD 22-01)
...
Appendix B: Federal Directive Quick Reference
  ...
  **Directive**     **Date Issued**   **Core Requirements**                                                                               **UIAO Relevance**
  ----------------- ----------------- --------------------------------------------------------------------------------------------------- -----------------------------------------------------------------------------------------------------------------------
  **BOD 22-01**     November 2021     REVOKED 2026-06-10 by BOD 26-04. Required agencies to remediate CISA-cataloged Known Exploited Vulnerabilities within specified timelines                 PKI ESC1-ESC8 detection; Nessus/Defender import adapters consume KEV-tagged findings
