...
![Current state (commercial cloud, undifferentiated)](images/cloud-image-02-current-state-commercial-cloud-u.png){#fig-cloud-image-02 fig-alt="Current state (commercial cloud, undifferentiated). Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}

![Target state (GCC-Moderate boundary + named exceptions, existing)](images/cloud-image-03-target-state-gcc-moderate-bounda.png){#fig-cloud-image-03 fig-alt="Target state (GCC-Moderate boundary + named exceptions, existing). Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}
