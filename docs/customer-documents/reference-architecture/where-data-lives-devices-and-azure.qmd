...
![Disposition-driven routing for OrgPath storage on devices and Azure resources under Model C — Microsoft Graph and Azure Resource Manager as two write transports, with the Codebook as shared per-facet validator above both storage surfaces.](../../images/canonical/UIAO-FIG-014-orgpath-device-azure-storage-routing.png){#fig-orgpath-device-azure-routing fig-alt="Model C OrgPath storage routing for devices and Azure resources. LEFT: a disposition decision selects between two write transports. MIDDLE: Microsoft Graph (for Entra devices) and Azure Resource Manager (for Arc machines). RIGHT: two resulting storage surfaces — 10 extensionAttribute slots on the Entra device, and the equivalent 10 ARM tags on the Arc machine. ABOVE: the Codebook as shared per-facet validator for both surfaces. 16:9 layered-architecture diagram, navy and teal palette." width="100%"}
...
- **Azure Policy enforcement on non-Arc resources** uses the same
  ...
  Config](../orgpath-narrative/Book_09.qmd)
  and
  [ch. 12 — OrgPath in Infrastructure Services](../orgpath-narrative/Book_12.qmd)
...
- [Customer narrative ch. 5 — OrgPath and Intune](../orgpath-narrative/Book_05.qmd)
- [Customer narrative ch. 9 — OrgPath and Azure Policy / Guest Config](../orgpath-narrative/Book_09.qmd)
- [Customer narrative ch. 12 — OrgPath in Infrastructure Services](../orgpath-narrative/Book_12.qmd)
