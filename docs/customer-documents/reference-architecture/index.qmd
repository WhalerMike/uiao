...
| [Intune-First Asset Onboarding](intune-first.qmd) | Procurement + endpoint teams governing **net-new** devices from day zero (per ADR-080; for existing-fleet GPO replacement see [GPO Sunset Program](../customer-documents/operational-guides/target-surface/intune-policy-templates.qmd)) |
