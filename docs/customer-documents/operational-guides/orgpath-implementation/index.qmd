...
These guides are the *how*. Their companion, the **[UIAO OrgPath narrative](../../orgpath-narrative/index.qmd)**, is the *what* and *why*: the seventeen-document reading sequence on the governance substrate Microsoft did not build and the Microsoft surfaces that consume the OrgPath facet.
:::
