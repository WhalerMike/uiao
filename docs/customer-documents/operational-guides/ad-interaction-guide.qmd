...
![AD forest/domain topology discovery model](images/ad-interaction-guide-image-01-ad-forestdomain-topology-discove.png){#fig-ad-interaction-guide-image-01 fig-alt="AD forest/domain topology discovery model. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}

![UIAO AD assessment pipeline data flow](images/ad-interaction-guide-image-02-uiao-ad-assessment-pipeline-data.png){#fig-ad-interaction-guide-image-02 fig-alt="UIAO AD assessment pipeline data flow. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}

![OU/GPO hierarchy and linkage diagram](images/ad-interaction-guide-image-03-ougpo-hierarchy-and-linkage-diag.png){#fig-ad-interaction-guide-image-03 fig-alt="OU/GPO hierarchy and linkage diagram. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}

![Gitea API integration sequence](images/ad-interaction-guide-image-04-gitea-api-integration-sequence.png){#fig-ad-interaction-guide-image-04 fig-alt="Gitea API integration sequence. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}
