...
> PNGs via Google Gemini's Nano Banana model. Run once with
...
> is passed.
>
> **Visual language for the series.** All figures share a consistent
> UIAO aesthetic:
>
> - **Palette:** neutral slate + federal navy (#1F3A5F) accents; soft
>   teal (#1A9E8F) and amber (#D4A017) for highlights; avoid
>   vendor-branded reds/greens.
> - **Typography:** clean sans-serif for labels; monospace for canon
>   identifiers (UIAO_NNN, DRIFT-*, OrgPath values).
> - **Style:** diagrammatic / technical illustration. Engineering
>   reference-architecture style; not photographic, not isometric-3D.
> - **Backgrounds:** white or very light slate; no gradients.
> - **Aspect ratio:** 16:9 landscape (1440×810). Embedded at 720px wide.
...
**Chapter:** [00 — 00-program-overview.qmd](./00-program-overview.qmd)

**Caption:** *Figure 0.1 — Six Control Planes Interaction Model.*

**Source placeholder:** `DIAGRAM 1` (manifest `UIAO_010-FIG-01`)
...
**Size:** 1440×810 (16:9 landscape). Embed 720px.
...
**Caption:** *Figure 0.2 — Modernization Phase Progression.*

**Source placeholder:** `DIAGRAM 2` (manifest `UIAO_010-FIG-02`)
...
**Chapter:** [02 — 02-phase1-modernization-mechanics.qmd](./02-phase1-modernization-mechanics.qmd)

**Caption:** *Figure 2.1 — Diagram showing OrgPath architecture with user AUs on the left, device correlation flow in the.*

**Source placeholder:** `DIAG-001` (manifest `UIAO_021-FIG-01`)
...
**Caption:** *Figure 2.2 — Flowchart showing GPO-to-Intune conversion pipeline: GPO Export (XML via Get-GPOReport) → Group.*

**Source placeholder:** `DIAG-002` (manifest `UIAO_021-FIG-02`)
...
**Caption:** *Figure 2.3 — Diagram showing the UIAO Drift Detection and Remediation Workflow: Detection Sources (UTCM via.*

**Source placeholder:** `DIAG-003` (manifest `UIAO_021-FIG-03`)
...
**Caption:** *Figure 2.4 — Diagram 2: Identity Synchronization Architecture** **Dimensions:** 6.*

**Source placeholder:** `PLACEHOLDER-DIAGRAM-002` (manifest `UIAO_021-FIG-04`)
...
**Caption:** *Figure 2.5 — Diagram 6: GCC-Moderate Network Visibility Architecture** **Dimensions:** 6.*

**Source placeholder:** `PLACEHOLDER-DIAGRAM-006` (manifest `UIAO_021-FIG-05`)
...
**Caption:** *Figure 2.6 — Diagram 7: Modernization Wave Dependency and Timeline** **Dimensions:** 6.*

**Source placeholder:** `PLACEHOLDER-DIAGRAM-007` (manifest `UIAO_021-FIG-06`)
...
**Chapter:** [03 — 03-phase2-governance-os.qmd](./03-phase2-governance-os.qmd)

**Caption:** *Figure 3.1 — Governance OS Five-Layer Architecture.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-01`)
...
**Caption:** *Figure 3.2 — Governance OS Core Data Model --- Entity Relationship Diagram.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-02`)
...
**Caption:** *Figure 3.3 — Microsoft Security and Compliance Stack Integration Map.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-03`)
...
**Caption:** *Figure 3.4 — UIAO SCuBA Integration Flow.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-04`)
...
**Caption:** *Figure 3.5 — Drift Detection Engine Processing Flow.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-05`)
...
**Caption:** *Figure 3.6 — Remediation Workflow State Machine.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-06`)
...
**Caption:** *Figure 3.7 — Provenance Chain Structure.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-07`)
...
**Caption:** *Figure 3.8 — Cross-Plane Telemetry Ingestion Architecture.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-08`)
...
**Caption:** *Figure 3.9 — Continuous ATO Evidence Generation Pipeline.*

**Source placeholder:** `UNTAGGED` (manifest `UIAO_022-FIG-09`)
...
**Caption:** *Figure 4.2 — Optimized drift detection flow showing five drift engines (Identity/Sentinel, Device/Intune.*

**Source placeholder:** `P3-D-002` (manifest `UIAO_023-FIG-02`)
...
**Caption:** *Figure 4.3 — SLA enforcement closed-loop sequence: (1) Telemetry sources (CQD, MINR, SD-WAN, Sentinel, Intune.*

**Source placeholder:** `P3-D-003` (manifest `UIAO_023-FIG-03`)
...
**Caption:** *Figure 4.4 — Multi-tier dashboard architecture showing data flow from source systems (Sentinel, Defender.*

**Source placeholder:** `P3-D-004` (manifest `UIAO_023-FIG-04`)
...
**Chapter:** [05 — 05-phase4-multi-agent.qmd](./05-phase4-multi-agent.qmd)

**Caption:** *Figure 5.1 — Multi-Agent Governance Topology.*

**Source placeholder:** `P4_DIA_001` (manifest `UIAO_024-FIG-01`)
...
**Caption:** *Figure 5.2 — Drift Intelligence Engine Data Flow.*

**Source placeholder:** `P4_DIA_002` (manifest `UIAO_024-FIG-02`)
...
**Caption:** *Figure 5.3 — SSOT Artifact Paths and Agent Interactions.*

**Source placeholder:** `P4_TBL_001` (manifest `UIAO_024-FIG-03`)
...
**Caption:** *Figure 5.4 — Adapter Doctrine --- Streaming Mode Integration.*

**Source placeholder:** `P4_DIA_003` (manifest `UIAO_024-FIG-04`)
...
**Caption:** *Figure 5.5 — Coordination Epoch Sequence.*

**Source placeholder:** `P4_DIA_004` (manifest `UIAO_024-FIG-05`)
...
**Caption:** *Figure 5.6 — Predictive Model Output Schema.*

**Source placeholder:** `P4_TBL_002` (manifest `UIAO_024-FIG-06`)
...
**Caption:** *Figure 5.7 — Autonomous Remediation Decision Flow.*

**Source placeholder:** `P4_DIA_005` (manifest `UIAO_024-FIG-07`)
...
**Caption:** *Figure 5.8 — Human-in-the-Loop Control Architecture.*

**Source placeholder:** `P4_DIA_006` (manifest `UIAO_024-FIG-08`)
...
**Caption:** *Figure 5.9 — Provenance Header Schema.*

**Source placeholder:** `P4_TBL_003` (manifest `UIAO_024-FIG-09`)
...
**Caption:** *Figure 5.10 — Control Maturity Evolution Model.*

**Source placeholder:** `P4_DIA_007` (manifest `UIAO_024-FIG-10`)
...
**Caption:** *Figure 5.11 — Runbook Conformance Checklist.*

**Source placeholder:** `P4_TBL_004` (manifest `UIAO_024-FIG-11`)
...
**Caption:** *Figure 5.12 — Phased Rollout Schedule.*

**Source placeholder:** `P4_TBL_005` (manifest `UIAO_024-FIG-12`)
...
**Chapter:** [06 — 06-phase5-canon-integration.qmd](./06-phase5-canon-integration.qmd)

**Caption:** *Figure 6.1 — Canon Consolidation Workflow.*

**Source placeholder:** `P5_DIA_001` (manifest `UIAO_025-FIG-01`)
...
**Caption:** *Figure 6.2 — Artifact Consolidation Status Matrix.*

**Source placeholder:** `P5_TBL_001` (manifest `UIAO_025-FIG-02`)
...
**Caption:** *Figure 6.3 — Canonical Artifact Lifecycle State Machine.*

**Source placeholder:** `P5_DIA_002` (manifest `UIAO_025-FIG-03`)
...
**Caption:** *Figure 6.4 — Baseline Versioning and Branching Model.*

**Source placeholder:** `P5_DIA_003` (manifest `UIAO_025-FIG-04`)
...
**Caption:** *Figure 6.5 — Evidence Archival Tiered Storage Model.*

**Source placeholder:** `P5_DIA_004` (manifest `UIAO_025-FIG-05`)
...
**Caption:** *Figure 6.6 — Evidence Retention Schedule.*

**Source placeholder:** `P5_TBL_002` (manifest `UIAO_025-FIG-06`)
...
**Caption:** *Figure 6.7 — Extensibility Interface Architecture.*

**Source placeholder:** `P5_DIA_005` (manifest `UIAO_025-FIG-07`)
...
**Caption:** *Figure 6.8 — Canonical Baseline Lifecycle Detail.*

**Source placeholder:** `P5_DIA_006` (manifest `UIAO_025-FIG-08`)
...
**Caption:** *Figure 6.9 — Evidence Retrieval Interface Specification.*

**Source placeholder:** `P5_TBL_003` (manifest `UIAO_025-FIG-09`)
...
**Caption:** *Figure 6.10 — Governance Lifecycle Management Feedback Loop.*

**Source placeholder:** `P5_DIA_007` (manifest `UIAO_025-FIG-10`)
...
**Caption:** *Figure 6.11 — Governance Branching and Merge Workflow.*

**Source placeholder:** `P5_DIA_008` (manifest `UIAO_025-FIG-11`)
...
**Caption:** *Figure 6.12 — Assessor Interface Capability Matrix.*

**Source placeholder:** `P5_TBL_004` (manifest `UIAO_025-FIG-12`)
...
**Caption:** *Figure 6.13 — Continuous ATO Operational Cadence Schedule.*

**Source placeholder:** `P5_TBL_005` (manifest `UIAO_025-FIG-13`)
...
**Caption:** *Figure 6.14 — Four-Layer Operational Cadence Architecture.*

**Source placeholder:** `P5_DIA_009` (manifest `UIAO_025-FIG-14`)
...
**Caption:** *Figure 6.15 — Migration Stage Dependency Matrix.*

**Source placeholder:** `P5_TBL_006` (manifest `UIAO_025-FIG-15`)
