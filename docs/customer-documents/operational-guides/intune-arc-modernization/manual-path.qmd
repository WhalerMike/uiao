---
title: "Intune + Azure Arc — Manual Path"
subtitle: "The end-to-end modernization runbook with no governance control plane: each operator owns the decision under local change control"
doc-type: operational-guide
audience: [Customer, Operator, Technical]
author: Michael Stratton
date: "June 2026"
status: Active
repo-path: docs/customer-documents/operational-guides/intune-arc-modernization/manual-path.qmd
...
deadline for NTLM elimination is **2027-04-01** ([FedRAMP Notice 0009](https://www.fedramp.gov/20x/notice-0009/)).
