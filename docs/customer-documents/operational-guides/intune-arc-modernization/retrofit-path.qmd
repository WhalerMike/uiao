---
title: "Intune + Azure Arc — Add OrgPath Later (Retrofit)"
subtitle: "For estates already modernized the manual way: how to layer UIAO/OrgPath governance on top without re-doing the Intune or Arc work"
doc-type: operational-guide
audience: [Customer, Operator, Technical]
author: Michael Stratton
date: "June 2026"
status: Active
repo-path: docs/customer-documents/operational-guides/intune-arc-modernization/retrofit-path.qmd
