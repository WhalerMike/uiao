...
This series is the end-to-end transformation journey of **OrgMod**, the
modernization expression of the UIAO substrate — see the
[OrgMod hub](../../../orgmod/index.qmd) for the pillar's front door.

**[client-server-to-hybrid-cloud-bundle.docx](https://github.com/WhalerMike/uiao/releases/download/downloads-latest/client-server-to-hybrid-cloud-bundle.docx)** — every page in this section concatenated into one Word document. Regenerated on every site deploy.
:::
