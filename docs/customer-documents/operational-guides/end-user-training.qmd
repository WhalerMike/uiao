...
![Windows Hello for Business enrollment screen mockup](images/end-user-training-image-02-windows-hello-for-business-enrol.png){#fig-end-user-training-image-02 fig-alt="A laptop screen rendering of the Windows 11 Settings → Accounts → Sign-in options panel, with three highlighted enrollment cards: \"Face recognition (Windows Hello)\" with a small camera icon, \"Fingerprint recognition (Windows Hello)\" with a fingerprint icon, and \"PIN (Windows Hello)\" with a numeric-pad icon — each card showing a teal \"Set up\" button. A side callout labeled \"Tied to this device only\" points to the PIN card; a second callout labeled \"Hardware-backed by the TPM\" points to the laptop chassis. Clean Windows-11 UI illustration style, dark navy (#0D1B2E) and teal (#1E8C8C) accents on white background. No photographs, no human faces, purely a UI mockup." width="85%"}
...
![Conditional Access block-page mockup](images/end-user-training-image-04-conditional-access-block-page-mo.png){#fig-end-user-training-image-04 fig-alt="A browser window centered on a Microsoft-styled \"You can't access this right now\" message, with a sub-line \"Your sign-in was successful, but doesn't meet the criteria to access this resource.\" At the bottom of the page, a \"Correlation ID:\" label with a sample GUID, outlined in amber and pointed to by a callout arrow labeled \"Share this ID with IT — it helps them diagnose the issue quickly.\" Clean Microsoft 365 sign-in UI styling, dark navy (#0D1B2E) and teal (#1E8C8C) accents on white background, with amber (#D4A017) reserved for the correlation-ID highlight only. No photographs, no human figures, purely a UI illustration." width="85%"}
