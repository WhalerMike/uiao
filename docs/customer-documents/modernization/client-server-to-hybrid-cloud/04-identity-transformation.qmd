...
![Figure 4.1 — A single OrgPath attribute drives five downstream governance outcomes](images/04-orgpath-fanout.png){fig-alt="Fanout diagram with a user object in the center showing extensionAttribute1 = ORG-FIN-AP-EAST, radiating arrows to five outcomes: dynamic group membership (OrgTree-FIN-AP-Users), Administrative Unit scope (AU-ORG-FIN-AP), Conditional Access targeting, group-based license assignment, and MOD_M drift validation" width="720"}
...
![Identity transformation pipeline diagram showing the flow: Legacy AD Objects...](images/04-identity-transformation-image-02-identity-transformation-pipeline.png)
...
- **Customer Documents:** [modernization/orgtree.qmd](../../../modernization/orgtree.html)
