...
subtitle: "Eight-chapter white paper on logical centralization, token-based security, the speed-of-light tax, SD-WAN differentiated transport, and token-bound transport governance — and how UIAO resolves them."
...
**[ssot-network-physics-bundle.docx](https://github.com/WhalerMike/uiao/releases/download/downloads-latest/ssot-network-physics-bundle.docx)** — every chapter in this white paper concatenated into one Word document. Regenerated on every site deploy.
:::
...
- **05** — [The Governed Path — Token-Bound Transport and the Application-Aware Overlay](./05-governed-path-transport.html)
  - *Forward-looking (Proposed, ADR-066).* Why an efficient edge device needs an identity-anchored fabric, and how the path becomes governed evidence
...
- **07** — [Reference Architecture — UIAO SaaS Data Plane](./07-reference-architecture-uiao.html)
...
source-of-truth doctrine) under `src/uiao/canon/adr/` — and, for the
forward-looking Chapter 5, the *Proposed* **ADR-066** (Application-Aware
