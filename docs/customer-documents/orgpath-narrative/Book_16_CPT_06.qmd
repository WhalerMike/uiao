...
[DIAGRAM-06: Engineering blueprint, white background, 16:9 landscape. Center, a single federal-navy server box labeled "SUBSTRATE AUTHORITY" sits inside a closed amber loop labeled "the same drift loop that watches the directory". Around the loop, four amber waypoints with monospace labels: "carries OrgPath", "inside an Administrative Unit", "compliance evaluated on cadence", "drift reported to the engine". Below, two teal hand-off cards point rightward off the diagram labeled "→ Build runbook (UIAO_SBG_001)" and "→ Decision of record (ADR-041)", under a caption "narrative ends · runbook begins". Federal navy #1F3A5F for the authority, amber #D4A017 for the governance loop and waypoints, teal #1A9E8F for the hand-off cards, monospace labels, no human figures.]
