...
![Subtree delegation vs flat Administrative Units — a role assigned once in AD flows down the subtree; in Entra each AU must be assigned again.](../../images/canonical/UIAO-FIG-028-delegation-inheritance-vs-flat.png){#fig-delegation-vs-flat fig-alt="Two halves split by a hairline. Left, Active Directory subtree delegation — a vertical navy chain Agency Root to West Region (role assigned here, covers all children) to West Finance, tagged one assignment inherited. Right, Entra ID flat Administrative Units — two separate ice boxes for West Region and West Finance, the second noting the role must be assigned again, with a caption no structural relationship no role flow and a red tag N assignments one per AU." width="100%"}
