...
```python
# adapters/targeting/__init__.py — illustrative sketch (shipped as src/uiao/adapters/entra_policy_targeting.py)
...
```python
# adapters/network-aaa/_contract.py — illustrative sketch (adapter registered per ADR-107; module not yet shipped)
