...
![The anchor holds the record; the beacon only reports the weather](images/book19cpt05-image-01-anchor-and-beacon.png){#fig-book-19-cpt-05-image-01 fig-alt="Illustrative sea scene, 16:9 landscape on a white canvas. A horizon line splits the frame: a pale blue sky gradient above, and water below that fades from ice blue at the surface to deep navy at the bottom. Below the waterline on the left, a heavy navy anchor with ring, shank, crossbar, and curved flukes hangs on a taut dashed chain running up toward the surface; a small ice-blue label beside it reads record. Above the waterline on the right, a small navy buoy tilts as if drifting, carrying a grey mast topped by a teal beacon lamp with a soft pale-teal glow and three concentric teal ripple rings; a grey label beside it reads signal. A thin dashed red line connects buoy to anchor, broken at its midpoint by a red prohibition circle with a slash." width="100%"}
