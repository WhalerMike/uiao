...
| **Planned PowerShell modules** | UIAOImportAdapters is now implemented (`tools/powershell/UIAOImportAdapters/`, per UIAO_182); UIAOIdentityAssessment and UIAOPlanGenerators have specifications but not implementations |
