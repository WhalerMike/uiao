...
::: {.callout-note}
## In this chapter
This document begins where the companion volume stopped: it translates the
structural gap in the Microsoft cloud stack into a **requirements language** —
not what the platform lacks, but what must exist to close it — and states the
**six baseline requirements** any governance substrate must satisfy to be
...
That distinction matters more than it may initially appear. A list of platform limitations invites a search for compensating features — another license tier, another configuration option, another integration that might bridge the distance between what the tool does and what the organization needs. The companion document made clear that the gap in question cannot be closed that way. It is not a collection of missing features remediable by configuration changes or additional licensing. It is a structural absence.
