...
![A site is not an address — it is a stamped, governed subject](images/book19cpt06-image-01-the-stamped-site.png){#fig-book-19-cpt-06-image-01 fig-alt="Illustrative scene on a white canvas, 16:9 landscape. A large open passport-style booklet fills most of the frame, with navy cover edges showing around two gently curved ice-blue pages that meet at a soft grey spine gutter. On the left page sits a simple stylized building pictogram: a navy-outlined block with a triangular pediment roof, six square navy windows, and a navy door. Three circular stamp seals are pressed onto the pages at slight angles, each a double ring with a subtle pale-teal glow: a teal seal reading E911 at the upper right, a navy seal reading TIC 3.0 at the lower right, and a grey seal reading BOUNDARIES at the lower left. A thin embossed monospace line near the bottom of the right page reads /USA/MD/ANNAPOLIS-HQ." width="85%"}
