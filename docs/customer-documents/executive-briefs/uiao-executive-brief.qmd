...
![UIAO Governance OS](media/image1.png){fig-alt="UIAO Governance OS overview" width="100%"}
...
![The manual compliance grind](media/image2.png){fig-alt="Current state: manual, fragmented compliance workflows" width="100%"}
...
![Continuous monitoring pipeline](media/image3.png){fig-alt="UIAO continuous monitoring of 323 FedRAMP Moderate Rev 5 controls" width="100%"}
...
![Before and after UIAO](media/image4.png){fig-alt="Compliance operations before and after UIAO deployment" width="100%"}
...
![Three compliance layers](media/image5.png){fig-alt="FedRAMP Moderate Rev 5, CISA SCuBA and BOD 25-01, and organizational policies" width="100%"}
...
![Immutable provenance chain](media/image6.png){fig-alt="Cryptographically signed immutable evidence chain for audit records" width="100%"}
...
![UIAO differentiators](media/image7.png){fig-alt="Three ways UIAO differs from conventional compliance dashboards" width="100%"}
...
![Getting started with UIAO](media/image8.png){fig-alt="Next steps and engagement path for UIAO adoption" width="100%"}
