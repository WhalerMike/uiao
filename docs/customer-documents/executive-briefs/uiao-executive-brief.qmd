...
![UIAO differentiators](../../images/canonical/UIAO-FIG-007-uiao-differentiators.png){fig-alt="Three ways UIAO differs from conventional compliance dashboards" width="100%"}
...
![Getting started with UIAO](../../images/canonical/UIAO-FIG-008-getting-started.png){fig-alt="Next steps and engagement path for UIAO adoption" width="100%"}
