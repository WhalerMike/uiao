...
![Continuous monitoring pipeline](../../images/canonical/UIAO-FIG-003-continuous-monitoring-pipeline.png){fig-alt="UIAO continuous monitoring pipeline checking tenant configuration against 323 FedRAMP Moderate Rev 5 controls plus SCuBA and BOD 25-01 baselines." width="100%"}
