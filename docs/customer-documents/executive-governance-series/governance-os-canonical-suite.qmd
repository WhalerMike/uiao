...
- OrgPath facet values are stored in their codebook slots (`extensionAttribute1-3`, 6, 9 and 10) and the derived path in extensionAttribute15, all on the Entra ID directory object and therefore within the M365 GCC-Moderate boundary.
