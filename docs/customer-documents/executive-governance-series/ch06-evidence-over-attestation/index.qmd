...
![Attestation-primary vs evidence-primary stack inversion](images/index-image-02-attestation-primary-vs-evidence.png){#fig-index-image-02 fig-alt="Attestation-primary vs evidence-primary stack inversion. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="100%"}
...
**At a glance — two artifacts, one inversion:**

| | Attestation | Evidence |
|---|---|---|
| What it is | A human signing that something is true | A machine-verifiable artifact showing it is |
| Temporal scope | Point-in-time | Continuous between events |
| Verification | Re-read | Re-execute and hash-check |
| Role in UIAO | Human accountability wrapper | Primary artifact |
...
verification, not just *cheaper*.

> **An assessor can re-execute and verify; an attestation can only be
> re-read.** That is the whole of the inversion.
...
Next: [Chapter 7 — Operational Tempo](../ch07-operational-tempo/index.qmd) — the cadence at which detection, remediation, and escalation must run for the evidence to stay truthful.
:::
