...
forty-year arc into a single paper. What survives here is the vendor- and
product-neutral edition: it cites only NIST, OMB, CISA and FedRAMP, and asserts
nothing that depends on any particular product, platform, or vendor. It is
written to be read, and handed on, without a platform commitment attached.
:::
