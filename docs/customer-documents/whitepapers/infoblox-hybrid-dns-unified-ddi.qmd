...
This whitepaper is **DRAFT v0.3** (July 2026; external claims re-verified
2026-07-27 — the INR sovereign-cloud restriction is unchanged on Microsoft
Learn, the April 2026 Infoblox release is reflected in §7.4, and the
2026-07-22 Infoblox Government Cloud FedRAMP Moderate certification is now
reflected in §7.8). The two Appendix A sources originally marked unreachable
were re-checked on 2026-07-27: both return only a bare page title to a plain
