...
UIAO's substrate decomposes into six governance domains that implement a
federated governance model — the same architecture federal agencies prefer for balancing enterprise-wide standards
with operational autonomy.

| UIAO governance domain | Federal governance equivalent |
|---|---|
| Identity domain | CDO-designated identity SSOT |
| Authorization domain | Data access policy standards |
| Compliance domain | FedRAMP / NIST continuous monitoring |
| Migration domain | Transition governance and rollback authority |
| Evidence domain | Audit, lineage, and reporting |
| Operational domain | Regional / silo operational continuity |
...
federated execution. (These governance domains are this paper's federated
reading of the substrate and are distinct from the canon's six control
planes — Identity, Addressing, Overlay, Telemetry, Management, Governance —
defined in ADR-030; the domains describe who governs, the control planes
describe what the substrate acts on.)
