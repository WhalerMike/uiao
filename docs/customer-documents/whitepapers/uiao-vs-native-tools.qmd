...
![Three-layer orchestration stack (MS tools / UIAO / Governance Outcomes)](images/zero-trust-governance-whitepaper-image-01-ztmm-five-pillar-bridge-diagram.png){#fig-uiao-vs-native-tools-image-01 fig-alt="Three-layer orchestration stack (MS tools / UIAO / Governance Outcomes). Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="100%"}

![12-tool coverage matrix heatmap](images/zero-trust-governance-whitepaper-image-02-identity-as-root-namespace-tree.png){#fig-uiao-vs-native-tools-image-02 fig-alt="12-tool coverage matrix heatmap. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="100%"}

![SCuBA-parallel side-by-side](images/zero-trust-governance-whitepaper-image-03-ztmm-maturity-progression-chart.png){#fig-uiao-vs-native-tools-image-03 fig-alt="SCuBA-parallel side-by-side. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="100%"}
