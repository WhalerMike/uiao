...
4. **Reconcile duplicates and lifecycle.** Phantom/stale device objects are
...
5. **Emit evidence an AO can sign.** Every wave produces signed
   ...
   their name to.
6. **Cover the whole denominator.** Non-Windows, BYOD, and guest surfaces are
...
| Control-plane / data-plane separation as the spine | [ADR-092](../../../src/uiao/canon/adr/adr-092-active-governance.md) | This paper is one worked operation inside that larger arc (the *modernization-journey* whitepaper, forthcoming, tells it end to end). |
...
2026-06-08 for review; not yet promoted or published.
:::
...
- Companion narrative (forthcoming): *From Mainframe to Application-Aware Modernization* — the control-plane/data-plane arc this paper sits inside.
