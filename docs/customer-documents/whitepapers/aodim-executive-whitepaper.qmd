...
Four further slots are reserved for tenant-declared facets. The native
`manager` relationship is consumed alongside these facets but is a
standard directory attribute, not an OrgPath facet. See the
