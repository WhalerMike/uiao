...
*End of foundational reference. The companion series on how a governance substrate assists in this transformation is published as the [OrgPath Narrative](../orgpath-narrative/index.qmd) — a fifteen-document reading sequence beginning with [The Microsoft Identity and Governance Stack — Native Capabilities and Inherited Limitations](../orgpath-narrative/01-microsoft-identity-and-governance-stack.qmd).*
