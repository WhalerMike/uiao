...
The 2027-04-01 NTLM elimination deadline is not a migration completion date in the CCM-BIR context — it is the date by which the records for all production instances must have been in the satisfied state continuously for a sufficient validation period. Migration activity should conclude well before 2027-04-01; the final months before the deadline are the continuous-audit validation period, not the migration period. (ADR-068 Phase C, ADR-091 §5)
