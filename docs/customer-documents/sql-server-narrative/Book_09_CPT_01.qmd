...
The program's NTLM elimination strategy is not about hitting a fixed block date — it is about driving all production instance CCM-BIR records to the satisfied state and keeping them there continuously. Migration activity should conclude with enough margin for the continuous audit to confirm the satisfying posture across a full validation period before Phase C is applied. (ADR-068 Phase C and ADR-091 §5)
