...
**[sql-server-narrative-bundle.docx](https://github.com/WhalerMike/uiao/releases/download/downloads-latest/sql-server-narrative-bundle.docx)** — every page in this section concatenated into one Word document. Regenerated on every site deploy.
:::
...
Microsoft is moving the SQL Server identity floor — version end-of-support,
Extended Security Updates gated behind Azure Arc, and NTLM deprecation — on a
timeline the agency does not set. The choices that remain (stay on SQL Server,
or consolidate onto PostgreSQL or Oracle) and a profile-driven recommendation
matrix are summarized for leadership in a single reference page:

**[The Forcing Function — Agency Choices & Recommendations](decision-brief.qmd)**
