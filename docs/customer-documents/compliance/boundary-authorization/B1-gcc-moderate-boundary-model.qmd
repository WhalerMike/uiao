...
and
[`src/uiao/canon/compliance/reference/gcc-moderate-boundary-assessment/capabilities.md`]({{< meta canon-reference >}}capabilities.html).
...
- **Methodology**: [`src/uiao/canon/compliance/reference/gcc-moderate-boundary-assessment/methodology.md`]({{< meta canon-reference >}}methodology.html)
- **Per-capability dispositions**: [`capabilities.md`]({{< meta canon-reference >}}capabilities.html)
- **MITRE Chains A & B**: [`mitre-chains.md`]({{< meta canon-reference >}}mitre-chains.html)
- **Resolved positions on disputed questions**: [`resolved-positions.md`]({{< meta canon-reference >}}resolved-positions.html)
