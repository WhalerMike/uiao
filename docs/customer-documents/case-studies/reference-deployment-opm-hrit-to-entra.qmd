...
![HRIT inbound provisioning pipeline](images/reference-deployment-opm-hrit-to-image-02-hrit-inbound-provisioning-pipeli.png){#fig-reference-deployment-opm-hrit-to-entra-image-02 fig-alt="HRIT inbound provisioning pipeline. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}

![Six-phase deployment with drift findings](images/reference-deployment-opm-hrit-to-image-03-six-phase-deployment-with-drift.png){#fig-reference-deployment-opm-hrit-to-entra-image-03 fig-alt="Six-phase deployment with drift findings. Engineering blueprint style, neutral slate background, federal navy (#1F3A5F) for primary structural elements, teal (#1A9E8F) for secondary/integration elements, amber (#D4A017) for governance/audit/registry overlays, monospace labels for identifiers, no human figures, 16:9 landscape." width="85%"}
...
(`src/uiao/adapters/customer-documents/reference-architecture/hrit/inventory.py`). The pass:
