...
| zero active **type-U / type-G** logins | `WindowsLogins` array |
...
- A **new type-U / type-G** login on a previously Entra-only instance — Windows-backed identity reintroduced.
