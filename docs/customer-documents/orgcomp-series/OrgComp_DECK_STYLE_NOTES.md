...
|---|---|---|---|---|---|---|
| `Book_11_OrgComp_Vulnerability_Management.pptx` | 10.0 × 5.625 in | 462 (18.5/slide) | 0 | 4 | 25/25, avg 1953 ch | Arial + Consolas |
| `Book_10_OrgComp_Privileged_Access_Management.pptx` | 10.0 × 5.625 in | 518 (19.9/slide) | 0 | 2 | 26/26, avg 1910 ch | Arial |
| `Book_00_OrgComp_Executive_Summary.pptx` | 13.333 × 7.5 in | 183 (8.3/slide) | 19 | 1 | 22/22, avg 1754 ch | Calibri + Cambria |
