...
Every closure in orgcomp-compliance-spine.yml is a control-closure *claim*. This
...
Usage:
    python render_claim_evidence_test.py            # write OrgComp_Claim_Evidence_Test_Matrix.md
...
OUT = HERE / "OrgComp_Claim_Evidence_Test_Matrix.md"
...
def render() -> str:
    ...
    L.append(
        ...
        "`render_claim_evidence_test.py` from `orgcomp-compliance-spine.yml`. "
