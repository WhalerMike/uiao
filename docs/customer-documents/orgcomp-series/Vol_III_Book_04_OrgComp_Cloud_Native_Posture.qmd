...
| AWS | AWS Config (conformance packs) + AWS Security Hub | Yes | FedRAMP High (AWS GovCloud Class D) | High exceeds Moderate, boundary treatment documented; owned, so primary for AWS rather than relying on Defender's AWS ingestion |
...
| OCI | OCI Cloud Guard | No | FedRAMP High (DISA IL5 / JAB) | High exceeds Moderate, boundary treatment documented; residual-gap closer only — Defender's native coverage does not extend to OCI/OKE |
...
| AWS Security Hub (AWS, owned, FedRAMP High in AWS GovCloud) | <https://aws.amazon.com/about-aws/whats-new/2021/04/aws-security-hub-achieves-fedramp-high-authorization-to-enable-security-posture-management-for-high-impact-workloads/> |
...
| Oracle Cloud Guard (OCI, residual-gap closer, FedRAMP High / DISA IL5) | <https://www.oracle.com/security/cloud-security/cloud-guard/> |
