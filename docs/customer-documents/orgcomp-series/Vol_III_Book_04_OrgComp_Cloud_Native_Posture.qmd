...
Kubernetes — AKS/EKS/OKE/OpenShift) they are where a dominant class of cloud
incidents begins: misconfiguration, excessive entitlement, and exposure — not an
unpatched kernel.
...
at **FedRAMP Moderate** — a clean fit for the Moderate-only boundary. Its native
coverage does **not** extend to **OCI/OKE**, which is part of this estate; under
the Defender option OCI posture is a residual gap closed by a native **OCI Cloud
Guard** feed into the evidence fabric rather than by Defender itself.

The agency prefers **Palo Alto (Prisma Cloud)**, and Prisma Cloud is among the
most feature-complete CNAPPs — but it is **FedRAMP High-only**, as is **Wiz for
Government**.
...
Prisma Cloud** and **Wiz for Government** are among the most feature-complete
CNAPPs but are **FedRAMP High**. Choose Defender for Cloud to remain at Moderate, or document
