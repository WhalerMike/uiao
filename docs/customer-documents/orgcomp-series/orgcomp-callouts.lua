--[[ orgcomp-callouts.lua — render AAN Quarto callout / banner divs as styled docx boxes.
...
class to the matching style defined in orgcomp-reference.docx (built by
build_orgcomp_reference.py) via the `custom-style` attribute the docx writer honors.
