---
title: "Vol IV Book 04 — Federal Organization Compliance — PII Processing and Transparency"
...
aliases:
  - /customer-documents/federal-aan-series/Vol_IV_Book_04_FedAAN_PII_Processing_Transparency.html
...
scaffolding required at system boundary establishment for all {{< meta agency.short >}} GCC Moderate
...
FedRAMP 20x GCC Moderate systems operated by or on behalf of
{{< meta agency.formal >}}. The PT control family is the documentation layer that
...
This document applies to any {{< meta agency.short >}} GCC Moderate system that processes PII, including
but not limited to:
...
- **HR and workforce systems** — employee records, payroll, benefits
  administration within the {{< meta agency.short >}} Azure GCC Moderate boundary
...
> {{< meta agency.full >}} under FedRAMP 20x Authorization. This plan
...
> authority" is not sufficient. Consult {{< meta agency.short >}} Legal Counsel for each entry.

| PII Category | Legal Basis | Statutory / Regulatory Citation | Retention Period | Disposal Method |
|-------------|-------------|--------------------------------|-----------------|-----------------|
| Social Security Number (SSN) | Statutory | [CITATION] | [N years per records schedule] | NIST 800-88 purge |
| Name and date of birth | Statutory | [CITATION] | [N years per records schedule] | NIST 800-88 purge |
| Program payment records | Statutory | [CITATION] | 7 years post-case closure | NIST 800-88 purge |
| Medical / disability records | Statutory | [CITATION] | 5 years post-determination | Secure destruction + purge |
| Contact information (address, phone, email) | Statutory / Voluntary | [CITATION], or voluntary collection per E-Gov Act §208 | Duration of case + [N years] | NIST 800-88 purge |
| Financial account data (direct deposit) | Statutory | [CITATION] | 7 years | NIST 800-88 purge |
...
> each system of records within the authorization boundary. Reference the {{< meta agency.short >}}
> SORN database at {{< meta agency.domain >}}/privacy/sorns.html. If a SORN does not yet exist,
...
|------------------------|---------------|--------------------------|---------------|-------------|
| [SYSTEM NAME] | {{< meta agency.short >}}/[NUMBER] | [Vol. FR Page, Date] | [DATE] | [DATE] |
...
|------------|-----------------|---------------------|------------------|-------------------|-------------------|---------------|
| Citizen portal — online application | Statutory PII collection | Yes — {{< meta agency.statute >}} | No — notice only (PT-5) | Privacy notice displayed at form entry | N/A | `Confidential-PII` |
...
## Model Privacy Notice — {{< meta agency.short >}} Citizen Portal

> [FILLABLE] The following model notice may be adapted for any {{< meta agency.short >}} citizen-
...
**Collecting Agency:** {{< meta agency.formal >}}, [PROGRAM OFFICE]

**Legal Authority:** [CITATION — e.g., "Section 205(c) of the Social Security
Act (42 U.S.C. §405(c)) authorizes {{< meta agency.short >}} to collect this information."]

**Purpose:** {{< meta agency.short >}} collects this information to [PRIMARY PURPOSE — e.g.,
...
PURPOSE IF ANY — e.g., "detect and prevent fraud in connection with {{< meta agency.short >}}
programs"].

**Routine Uses:** {{< meta agency.short >}} may disclose information from this system as permitted
...
under {{< meta agency.statute >}} §[SECTION]"]. A complete list of routine uses appears
...
Privacy notices must appear at the following touchpoints on {{< meta agency.short >}} web systems:
...
## Special Categories Applicable to {{< meta agency.short >}} Systems
...
| Medical / health records (PHI) | Yes | HIPAA Privacy Rule (45 C.F.R. §164); {{< meta agency.short >}} Act §1106 |
...
{{< meta agency.short >}} systems that process health information in connection with Medicare Part B
coordination (CMS data exchanges), disability determination (medical records),
or employee health programs are subject to HIPAA where {{< meta agency.short >}} acts as a covered
...
> {{< meta agency.short >}} is acting as a covered entity, business associate, or neither for each
...
|---------|--------------|---------------|-------------------|-------------|----------------|----------------------|-------------------|-----------------|-----------------|
| DFL-001 | Citizen portal (intake form) | Name, DOB, SSN, address, contact info | Benefit application intake | {{< meta agency.short >}} case management system | No (internal) | TLS 1.3 | AES-256 CMK | [N years] | NIST 800-88 purge |
| DFL-002 | {{< meta agency.short >}} case management | SSN, medical records, benefit amounts | Disability determination | [CASE ADJUDICATION SYSTEM] | No (internal) | TLS 1.3 | AES-256 CMK | 5 years post-determination | Secure destruction + purge |
...
| DFL-004 | {{< meta agency.short >}} case management | SSN, benefit amount, tax withholding | Annual tax statement (1099) | IRS (FEDS Pay or direct filing system) | Yes — external federal | TLS 1.3 | AES-256 CMK | 7 years | NIST 800-88 purge |
| DFL-005 | {{< meta agency.short >}} — Medicare Part B records | PHI, SSN, Medicare ID | CMS coordination | Centers for Medicare & Medicaid Services | Yes — external federal | TLS 1.3 + payload encryption | AES-256 CMK | Per CMS DSA | Per CMS DSA |
...
in the {{< meta agency.short >}} GCC Moderate boundary:
...
*Previous: [Vol IV Book 03 — Program Management Governance](Vol_IV_Book_03_OrgComp_Program_Management_Governance.qmd)*

*Series: Federal Organization Compliance for {{< meta agency.short >}} GCC Moderate FedRAMP 20x*
