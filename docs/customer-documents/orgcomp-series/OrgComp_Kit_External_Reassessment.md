...
> (`OrgComp_Training_Program_External_Evaluation.md`, 8.7/10) — this time
...
| Master index at zip root | **Open** | `scripts/build_orgcomp_download.py` scope |
...
- **Master index at zip root** — `build_orgcomp_download.py` now writes an
