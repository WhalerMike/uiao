...
FR-EVD-002: Maintain the compliance spine (orgcomp-compliance-spine.yml) as the machine-readable SSOT for volumes, books, and control closures; every book's “Authorities Closed Here” table is generated from it and CI-checked against it (regen-and-diff discipline).
