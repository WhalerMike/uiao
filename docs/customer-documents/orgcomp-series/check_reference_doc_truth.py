...
orgcomp-reference.docx` on the command line. Pandoc ignores Quarto's nested
...
carry the AAN callout/FouoBanner paragraph styles — `orgcomp-reference.docx` is
lz-reference plus exactly those styles (build_orgcomp_reference.py). So the stale
