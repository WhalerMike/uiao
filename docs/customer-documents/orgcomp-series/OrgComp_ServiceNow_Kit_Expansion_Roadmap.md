...
> `OrgComp_Vol_VII_ServiceNow_Automation_Plan.md`, `OrgComp-Training-Program/OrgComp_Identity_Access_Governance_Kit_Requirements.docx`,
> `OrgComp_Series_Requirements.md`
...
5. **Everything as code, checked against the SSOT.** Each kit's control map is
   machine-readable data projected from `orgcomp-compliance-spine.yml`, CI-checked with
...
6. **Requirements before build.** Each new kit enters the portfolio through a
   ...
   `OrgComp_Identity_Access_Governance_Kit_Requirements.docx` / `OrgComp_Series_Requirements.md`
...
Detailed requirements: `OrgComp-Training-Program/OrgComp_Identity_Access_Governance_Kit_Requirements.docx`
...
1. Decide the Phase 2 kit's series home (Vol IX Book 06 vs. new volume) and register
   it in `orgcomp-compliance-spine.yml`.
...
- `docs/customer-documents/orgcomp-series/OrgComp-Training-Program/OrgComp_Identity_Access_Governance_Kit_Requirements.docx` — Phase 2 kit detailed requirements (Draft v0.9).
- `docs/customer-documents/orgcomp-series/OrgComp_Series_Requirements.md` — series-level requirements document.
- `docs/customer-documents/orgcomp-series/OrgComp_Vol_VII_ServiceNow_Automation_Plan.md` — Vol VII volume plan and doctrine guardrails.
- `docs/customer-documents/orgcomp-series/servicenow-day2/README.md` — Day-2 Kit data layer and remaining steps.
- `infoblox-ddi-book/servicenow-app/` — DDI Kit scoped-app exemplar.
- `docs/customer-documents/orgcomp-series/orgcomp-compliance-spine.yml` — the machine-readable SSOT every kit's control map projects from.
