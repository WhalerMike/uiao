...
| RA-5 | Vulnerability Monitoring and Scanning | Defender for Cloud / MDVM findings on Azure workloads flow to ServiceNow Vulnerability Response as prioritized remediation tasks | FedRAMP Moderate | NIST SP 800-53 Rev 5; CISA BOD 26-04 | Security / supply chain | KSI-MLA | No |
