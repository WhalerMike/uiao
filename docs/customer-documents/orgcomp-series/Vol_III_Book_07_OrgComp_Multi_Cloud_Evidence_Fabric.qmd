---
title: "Vol III Book 07 — Federal Organization Compliance — Multi-Cloud Evidence Fabric: One Compliance Picture from Many Stacks"
...
aliases:
  - /customer-documents/federal-aan-series/Vol_III_Book_07_FedAAN_Multi_Cloud_Evidence_Fabric.html
...
|---|---|---|---|
| **Aggregation / analytics lake** | **Microsoft Sentinel** — ingests AWS (Security Hub / GuardDuty / CloudTrail), OCI, GCP, and NEM syslog/CEF; FedRAMP-authorized | **Splunk Cloud Platform** (FedRAMP Moderate) | Both owned — dual-SIEM redundancy, not a default/alternative choice. Sentinel is the primary cross-vendor ingestion lake by breadth of native connectors; Splunk runs the same evidence contract in parallel, providing audit-log continuity if either platform's ingestion path fails |
...
time OSCAL bundle from it. **OMB M-26-14** (agency logging and network visibility, which rescinded M-21-31 on 22 May 2026 and replaced its EL0–EL3 tiers with a five-level maturity model scored to the lowest watermark) and **NIST
...
The agency owns both SIEM platforms: Sentinel and Splunk Cloud Platform run as
dual-SIEM redundancy, not a default/alternative choice pending procurement.
Sentinel is the primary aggregation lake on the Microsoft-preference rule
(earned by genuine multi-cloud/NEM ingestion at FedRAMP Moderate); Splunk runs
the same evidence contract in parallel. ServiceNow (FedRAMP-authorized, also
owned) is the workflow/CMDB coordination hub, with its CMDB reconciled to the
...
| OMB M-26-14 | Ensuring Effective and Efficient Agency Logging and Network Visibility (22 May 2026; rescinds M-21-31, *Improving the Federal Government's Investigative and Remediation Capabilities*) (event-logging maturity) — <https://www.whitehouse.gov/wp-content/uploads/2021/08/M-21-31-Improving-the-Federal-Governments-Investigative-and-Remediation-Capabilities-Related-to-Cybersecurity-Incidents.pdf> |
