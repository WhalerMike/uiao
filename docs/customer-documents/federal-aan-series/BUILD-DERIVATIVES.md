...
uiao generate aan-deck \
  --spec "docs/customer-documents/federal-aan-series/decks/Vol_VII_Book_00.yaml" \
  --out  "docs/customer-documents/federal-aan-series/Vol_VII_Book_00_FedAAN_ServiceNow_Automation_Overview.pptx"
```
...
```bash
cd "docs/customer-documents/federal-aan-series"
