...
| Vol I Book 07 | Federal AAN — Network Enforcement Substrate | Customer-owned NGFW/edge · distributed policy enforcement · accreditation gate | Cisco · Palo Alto · Juniper |
...
| Vol III Book 03 | Federal AAN — Patch & Systems Management | Flaw remediation · configuration state · SI-2 / CM closure | Azure Update Manager · multi-CSP patch |
| Vol III Book 04 | Federal AAN — Cloud-Native Security Posture & Containers | CSPM · CNAPP · Kubernetes runtime | Defender for Cloud · CSPM / CNAPP |
...
| Vol III Book 07 | Federal AAN — Multi-Cloud Evidence Fabric | Unified evidence contract · telemetry → CDM → KSI | Multi-CSP evidence pipeline |
...
| Vol IV Book 02 | Federal AAN — Supply Chain Risk Management | Syft CycloneDX SBOM · Grype vulnerability scan · OpenVEX exploitability · GitHub Actions pipeline | EO 14028 §4 / SR-family (remediation SLAs: BOD 26-04) |
...
| Vol IV Book 06 | Federal AAN — Authorization Package and ConMon | Agency RMF authorization package (ConMon evidence modeled on the FedRAMP 20x KSI schema) · OSCAL AP+AR+POA&M bundle · FedRAMP VDR/VER submission (NTC-0014) · CA-7 ConMon program | CA-2/5/6/7 · RA-3 · SA-15 |
...
| Vol IX Book 05 | Federal AAN — SaaS Integration Governance | SA-9 †, CA-3, AC-20 · verify authorization, then configure | Entra gallery · FedRAMP Marketplace · ServiceNow |
