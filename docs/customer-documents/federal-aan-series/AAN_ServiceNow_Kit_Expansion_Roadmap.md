...
- `docs/customer-documents/federal-aan-series/AAN-Training-Program/AAN_Identity_Access_Governance_Kit_Requirements.docx` — Phase 2 kit detailed requirements (Draft v0.9).
- `docs/customer-documents/federal-aan-series/AAN_Series_Requirements.md` — series-level requirements document.
- `docs/customer-documents/federal-aan-series/AAN_Vol_VII_ServiceNow_Automation_Plan.md` — Vol VII volume plan and doctrine guardrails.
- `docs/customer-documents/federal-aan-series/servicenow-day2/README.md` — Day-2 Kit data layer and remaining steps.
- `infoblox-ddi-book/servicenow-app/` — DDI Kit scoped-app exemplar.
- `docs/customer-documents/federal-aan-series/aan-compliance-spine.yml` — the machine-readable SSOT every kit's control map projects from.
