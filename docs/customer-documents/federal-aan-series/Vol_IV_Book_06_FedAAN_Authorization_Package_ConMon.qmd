...
(AAN) series. The preceding twenty-two content books, spanning Volumes I–IV, generated the evidence layer: infrastructure
...
| AAN Evidence Book Series | DOCX | the preceding twenty-two content books, Volumes I–IV (docs/customer-documents/federal-aan-series/) |
...
[<engine> adapter-run-scuba]
         ↓
[Governance Substrate] ←—— [AAN Slot Evidence YAMLs]
         ↓                                   ↑
