...
exists — see `AAN_CR26_Reconciliation.md`. Result: **19 of 46** CR26 indicators
...
`AAN_CR26_Reconciliation.md`) and assessed. These results are advisory pending
...
| OrgComp Evidence Book Series | DOCX | the preceding twenty-two content books, Volumes I–IV (docs/customer-documents/federal-aan-series/) |
...
- [ ] Confirm all twenty-two content books compiled and available in `docs/customer-documents/federal-aan-series/`
...
> **Indicator-level mapping is NOT asserted here.** The `CR26 Theme` column gives the CR26 Moderate *theme* each internal rule contributes to; the authoritative rule→indicator reconciliation (19 of the 46 CR26 indicators mapped) lives in [`AAN_CR26_Reconciliation.md`](AAN_CR26_Reconciliation.md). The `KSI-0NN` ids are the series' internal rules, not CR26 indicator ids.
