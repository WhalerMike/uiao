...
- `docs/customer-documents/federal-aan-series/Vol_VII_Book_05_FedAAN_ServiceNow_Compliance_App.qmd`
- `infoblox-ddi-book/servicenow-app/` (scoped-app exemplar)
- `docs/customer-documents/federal-aan-series/aan-compliance-spine.yml`
