...
description: "Compliance track of the OrgComp Training Program: nine modules (orientation plus the eight AAN evidence slots) that teach which controls each of the 20 AAN books closes, which FedRAMP 20x KSI category evaluates the closure, and how evidence flows through the engine's conformance pipeline."
---
