...
> Scope: `docs/customer-documents/federal-aan-series/` — new **Volume V**
...
> Source material: `docs/customer-documents/federal-aan-series/AAN-Training-Program/`
...
- **Staged folder:** once Books 00–04 absorb it, remove
  `docs/customer-documents/federal-aan-series/AAN-Training-Program/` (Phase 6) so the
