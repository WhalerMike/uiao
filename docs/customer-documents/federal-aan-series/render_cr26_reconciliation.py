...
Usage:
    python render_cr26_reconciliation.py               # write AAN_CR26_Reconciliation.md
...
REPO = _repo_root()  # docs/customer-documents/federal-aan-series -> repo root
OUT = HERE / "AAN_CR26_Reconciliation.md"
