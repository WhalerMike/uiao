...
MATRIX = HERE / "AAN_Claim_Evidence_Test_Matrix.md"

# Files whose prose quotes spine counts. Add to this list, not to the regexes,
# when a new book starts quoting them.
SCANNED = [
    "Vol_0_Book_00_FedAAN_Executive_Summary.qmd",
    "Vol_0_Book_00a_FedAAN_Executive_Brief.qmd",
    "Vol_0_Book_02_FedAAN_Control_Crosswalk.qmd",
]
