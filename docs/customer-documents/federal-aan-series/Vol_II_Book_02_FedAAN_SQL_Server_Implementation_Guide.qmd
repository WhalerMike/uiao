---
title: "Vol II Book 02 — Federal Application-Aware Networking — SQL Server Implementation Guide"
...
::: {.aan-important}
**Series Context** — This document is Vol II Book 02 of the Federal Application-Aware Networking series and the implementation companion to Vol II Book 01 (SQL Server Authentication Modernization). Vol II Book 01 covers the conceptual framework; this document provides the operational runbooks, command references, and configuration templates for execution.
:::
