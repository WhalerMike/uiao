---
title: "SCuBA Maintainer Onboarding"
subtitle: "Onboarding guide for SCuBA pipeline maintainers"
---
...
1. **UIAO SCuBA Pipeline Runbook**
   [docs/SCuBA-Pipeline-Runbook.qmd](SCuBA-Pipeline-Runbook.qmd)
...
1. Read the [Runbook](SCuBA-Pipeline-Runbook.qmd) end-to-end
