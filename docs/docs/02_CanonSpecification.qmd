...
The six control planes below are the **Tier B** Control-Plane decomposition per [ADR-030 §2](https://github.com/WhalerMike/uiao/blob/main/core/canon/adr/adr-030-pre-uiao-terminology-reconciliation.md). They sit **inside** the Tier A Control Plane (the second of four layers: Authority / Control / Overlay / Underlay). Canon-authoring prose uses Tier A; substrate-decision granularity uses Tier B. The mapping is authoritative in [UIAO_101 §Positioning](https://github.com/WhalerMike/uiao/blob/main/core/canon/specs/Platform-Overview.md).
:::
