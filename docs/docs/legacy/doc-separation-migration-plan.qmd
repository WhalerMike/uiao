...
Migrate the existing `uiao` repository to a structure that clearly separates user-facing documentation, machine-facing artifacts, and canonical definitions.
