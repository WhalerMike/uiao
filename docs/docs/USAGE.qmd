...
uiao oscal validate-ssp            # Validate OSCAL JSON artifacts with trestle models
...
python scripts/validate_schemas.py  # Deprecated; use uiao oscal validate-ssp
```
...
Or view the live site: https://whalermike.github.io/uiao/
