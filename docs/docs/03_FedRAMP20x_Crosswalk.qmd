...
- **Boundary assessment (the canonical gap matrix anchor)**:
  [`B1-gcc-moderate-boundary-model.qmd`](../customer-documents/compliance/boundary-authorization/B1-gcc-moderate-boundary-model.html).
- **ThousandEyes Networks-pillar adoption decision**:
  [`ADR-047`](../../src/uiao/canon/adr/adr-047-thousandeyes-networks-pillar-scope.html).
