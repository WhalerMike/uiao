...
This specification builds upon and formalizes the adapter registry defined in [`13_FIMF_AdapterRegistry.qmd`](./13_FIMF_AdapterRegistry.html).
...
**Cross-references:**
- [`13_FIMF_AdapterRegistry.qmd`](./13_FIMF_AdapterRegistry.html) -- Registry and discovery
- [`16_DriftDetectionStandard.qmd`](./16_DriftDetectionStandard.html) -- Drift taxonomy and remediation
- [`15_ProvenanceProfile.qmd`](./15_ProvenanceProfile.html) -- Mandatory provenance record
- [`19_ReconciliationModel.qmd`](./19_ReconciliationModel.html) -- Conflict resolution for multi-source claims
