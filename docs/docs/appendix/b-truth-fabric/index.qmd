...
|---|---|
| [B-01: Canonical Claim Schema](b-01-canonical-claim-schema.qmd) | The data structure for all UIAO integration assertions |
| [B-02: Identity Anchoring](b-02-identity-anchoring.qmd) | Cross-system identity correlation and Canonical Identity Records |
| [B-03: Multi-Cloud Identity Matrix](b-03-multi-cloud-identity-matrix.qmd) | Mapping of cloud provider identity constructs to canonical types |
| [B-04: Control Mapping Governance](b-04-control-mapping-governance.qmd) | How claims map to compliance controls and attestations |
