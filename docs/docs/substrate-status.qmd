...
| UIAO_113 | [Evidence Graph](https://github.com/WhalerMike/uiao/blob/main/src/uiao/canon/specs/graph-schema.md) | ✅ | working | scheduler-run ingestion + SAR augmentation; 27 tests | ✅ |
