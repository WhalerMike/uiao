...
| UIAO_114 | HA / Fault Tolerance | ✅ | — | **deferred to Phase 2** per [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd) | ⚠️ aspirational |
| UIAO_115 | Performance Engineering | ✅ | — | **deferred pending baseline** per [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd) | ⚠️ aspirational |
...
| UIAO_117 | Recovery Layer | ✅ | Phase 1 shipped | Raw-Zone immutability + checkpoint label in `src/uiao/storage/data_lake.py`; manual SOP for Class A/B in [Phase 1 record](../programs/project-plans/2026-04-26-uiao_117-phase1-recovery.qmd); Phase 2 deferred per [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd); 32 tests | 🟡 working |
| UIAO_118 | Release Engineering | ✅ | impl | release.yml signs v0.2.1 | ✅ |
| UIAO_119 | Tenancy Strategy | ✅ | v1 + v2 + tagging + check-points + API filter + sandbox + ops runbook + plane flags + CLI promote-preview shipped | `TenantClass` + `Environment` + `as_tag_dict` ([v1](../programs/project-plans/2026-04-26-uiao_119-v1-data-layer.qmd)); `FeatureFlag` + 12 reference flags ([v2](../programs/project-plans/2026-04-26-uiao_119-v2-feature-flags.qmd)); journal/archive tagging ([tagging](../programs/project-plans/2026-04-26-uiao_119-journal-tagging.qmd)); flag check-points ([check-points](../programs/project-plans/2026-04-26-uiao_119-checkpoint-wiring.qmd)); Auditor API filters ([API filter](../programs/project-plans/2026-04-26-uiao_119-auditor-api-tenant-filter.qmd)); `MigrationSandbox` ([sandbox](../programs/project-plans/2026-04-26-uiao_119-migration-sandbox.qmd)); canary→regulated rollout SOP ([runbook](../programs/ops-runbook/2026-04-26-uiao_119-canary-rollout.qmd)); orchestrator `select_planes` ([plane flags](../programs/project-plans/2026-04-26-uiao_119-orchestrator-plane-flags.qmd)); `uiao tenant promote-preview` CLI ([CLI promote](../programs/project-plans/2026-04-26-uiao_119-cli-tenant-promote.qmd)); only wave 2 CQL half open (gated on experimental CQL ops) per [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd) | 🟡 working |
...
| UIAO_121 | Adapter Conformance TP | ✅ (template) | 2 instantiations | [`terraform`](../customer-documents/validation-suites/adapters/terraform/terraform.qmd) (30/30 PASS) + [`entra-id`](../customer-documents/validation-suites/adapters/entra-id/entra-id.qmd) (30/30 PASS, tier-1 pending); also referenced by [scubagear conformance plan](../programs/test-plans/scubagear-conformance-test-plan.qmd) | 🟡 working |
| UIAO_122 | Adapter Developer Training | ✅ (subset of UIAO_125) | — | — | ⚠️ aspirational |
| UIAO_123 | Adapter Integration TP | ✅ (template) | 2 instantiations | [`terraform`](../customer-documents/validation-suites/adapters/terraform/terraform.qmd) (Phases 1–3 PASS) + [`entra-id`](../customer-documents/validation-suites/adapters/entra-id/entra-id.qmd) (Phases 1–3 PASS); both pending Phase 4–5 (live creds) | 🟡 working |
| UIAO_124 | Adapter Ops Runbook | ✅ | first instance shipped | [UIAO_119 canary → regulated rollout SOP](../programs/ops-runbook/2026-04-26-uiao_119-canary-rollout.qmd) (closes §4.4 assessment action 119.5) | 🟡 working |
| UIAO_125 | Training Program | ✅ | first delivery shipped | [adapter-author onboarding session record (2026-04-26)](../programs/training/2026-04-26-adapter-author-onboarding.qmd) | 🟡 working |
| UIAO_126 | Test Plans Program | ✅ | first delivery shipped | [scubagear conformance test plan](../programs/test-plans/scubagear-conformance-test-plan.qmd) instantiates UIAO_121 | 🟡 working |
| UIAO_127 | Project Plans Program | ✅ | first delivery shipped | [Acme Federal modernization plan](../programs/project-plans/agency-acme-modernization-plan.qmd) (synthetic reference shape) | 🟡 working |
| UIAO_128 | Education Program | ✅ | first delivery shipped | [agency onboarding walkthrough](../programs/education/agency-onboarding-walkthrough.qmd) (15-min CIO/CISO read) | 🟡 working |
...
**Total flagged ≈ 33 pages (~7% of the 504 rendered surfaces).** Selective flagging preserves signal — a banner on half the site is noise.
