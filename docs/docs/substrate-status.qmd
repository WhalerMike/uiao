...
| UIAO_121 | Adapter Conformance TP | ✅ (template) | first instantiation | [`terraform`](../customer-documents/validation-suites/adapters/terraform/terraform.qmd) (30/30 PASS); also referenced by [scubagear conformance plan](../programs/test-plans/scubagear-conformance-test-plan.qmd) | 🟡 working |
| UIAO_122 | Adapter Developer Training | ✅ (subset of UIAO_125) | — | — | ⚠️ aspirational |
| UIAO_123 | Adapter Integration TP | ✅ (template) | first instantiation | [`terraform`](../customer-documents/validation-suites/adapters/terraform/terraform.qmd) (Phases 1–3 PASS, 4–5 pending live creds) | 🟡 working |
...
- All `customer-documents/validation-suites/adapters/*` — 12 pages (13 → 12 once `terraform` flipped to active per §2.6 / 2026-04-26)
- All `customer-documents/adapter-specs/*` — 7 pages
- `docs/docs/canon/migration-plan.md`, `docs/docs/mvp-roadmap.qmd`

**Total flagged ≈ 34 pages (~7% of the 504 rendered surfaces).** Selective flagging preserves signal — a banner on half the site is noise.
