...
| UIAO_119 | Tenancy Strategy | ✅ | **all action items shipped** | v1 / v2 / tagging / check-points / API filter / sandbox / ops runbook / plane flags / [CLI promote-preview](../programs/project-plans/2026-04-26-uiao_119-cli-tenant-promote.qmd) / CQL experimental ops — see the [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd) for the full table of links. CQL `regex` op gated by `auditor-api.cql.experimental-ops` ([CQL exp ops](../programs/project-plans/2026-04-26-uiao_119-cql-experimental-ops.qmd)) | 🟡 working |
...
- All `customer-documents/validation-suites/adapters/*` — 10 pages (13 → 10 as `terraform`, `entra-id`, and `scubagear` flipped to active per §2.6 / UIAO_126 / 2026-04-26)
...
**Total flagged ≈ 21 pages (~4% of the 504 rendered surfaces).** Selective flagging preserves signal — a banner on half the site is noise.
