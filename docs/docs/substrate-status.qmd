...
| UIAO_119 | Tenancy Strategy | ✅ | v1 + v2 + journal/archive tagging + check-point wiring wave 1 shipped | `TenantClass` + `Environment` enums + `as_tag_dict` + walker P3 hygiene ([v1](../programs/project-plans/2026-04-26-uiao_119-v1-data-layer.qmd)); `FeatureFlag` + `FeatureFlagRegistry` + 6 reference flags + walker P3 hygiene ([v2](../programs/project-plans/2026-04-26-uiao_119-v2-feature-flags.qmd)); `EnforcementRuntime` + `ArchiveManager` honor `as_tag_dict` ([tagging](../programs/project-plans/2026-04-26-uiao_119-journal-tagging.qmd)); `BlockHandler` + `FilesystemArchive` honor `epl.action.block.enabled` + `data-lake.immutable.strict` ([check-points](../programs/project-plans/2026-04-26-uiao_119-checkpoint-wiring.qmd)); 119.3 (b) waves 2+3 + migration sandbox open per [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd) | 🟡 working |
