...
| UIAO_119 | Tenancy Strategy | ✅ | v1 + v2 + tagging + check-points + API filter + migration sandbox shipped | `TenantClass` + `Environment` enums + `as_tag_dict` + walker P3 hygiene ([v1](../programs/project-plans/2026-04-26-uiao_119-v1-data-layer.qmd)); `FeatureFlag` + `FeatureFlagRegistry` + 6 reference flags ([v2](../programs/project-plans/2026-04-26-uiao_119-v2-feature-flags.qmd)); journal/archive tagging ([tagging](../programs/project-plans/2026-04-26-uiao_119-journal-tagging.qmd)); `BlockHandler` + `FilesystemArchive` honor flag check-points ([check-points](../programs/project-plans/2026-04-26-uiao_119-checkpoint-wiring.qmd)); Auditor API `/journal` + `/archive` `tenant_id`+`environment` filters ([API filter](../programs/project-plans/2026-04-26-uiao_119-auditor-api-tenant-filter.qmd)); `MigrationSandbox` previews tenant/env changes before promotion ([sandbox](../programs/project-plans/2026-04-26-uiao_119-migration-sandbox.qmd)); 119.3 (b) waves 2+3 + 119.5 ops runbook open per [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd) | 🟡 working |
...
- **🟡 Partially implemented:** 12 (UIAO_002, 103, 110, 113, 117, 119, 121, 123, 125, 126, 127, 128)
- **⚠️ Aspirational or draft:** 17
