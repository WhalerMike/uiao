...
| UIAO_119 | Tenancy Strategy | ✅ | v1 + v2 + journal/archive tagging shipped | `TenantClass` + `Environment` enums + `TenantContext.as_tag_dict` + walker P3 hygiene ([v1](../programs/project-plans/2026-04-26-uiao_119-v1-data-layer.qmd)); `FeatureFlag` + `FeatureFlagRegistry` + 6 reference flags + walker P3 hygiene ([v2](../programs/project-plans/2026-04-26-uiao_119-v2-feature-flags.qmd)); `EnforcementRuntime` + `ArchiveManager` honor `as_tag_dict` gated by feature flags ([tagging](../programs/project-plans/2026-04-26-uiao_119-journal-tagging.qmd)); v2 check-point wiring + migration sandbox open per [§4.4 assessment](../programs/project-plans/2026-04-26-ha-perf-recovery-tenancy-assessment.qmd) | 🟡 working |
