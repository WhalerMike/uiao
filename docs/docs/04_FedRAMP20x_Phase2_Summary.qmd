...
- **MITRE Chains, gap matrix, and ZTMM ceiling**:
  [`docs/customer-documents/federal-aan-series/boundary/B1-gcc-moderate-boundary-model.qmd`](../customer-documents/federal-aan-series/boundary/B1-gcc-moderate-boundary-model.html).
