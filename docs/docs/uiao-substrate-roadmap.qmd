...
- ~~Compliance landing pages (8 sub-categories under `customer-documents/compliance/`)~~ — resolved by the July 2026 compliance consolidation: the tree retired; the Federal Compliance AAN Series is the compliance offering and the engine's compliance docs live in its companion volume (old URLs redirect).
