...
# Adapter Validation Suite — Terraform / OpenTofu
...
- Tier 2 contract fixtures: `tests/fixtures/contract/terraform/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_terraform_adapter.py`
