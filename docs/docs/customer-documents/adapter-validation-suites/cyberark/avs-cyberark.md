---
title: "AVS — CyberArk Privilege Cloud"
...
# Adapter Validation Suite — CyberArk Privilege Cloud
...
- Tier 2 contract fixtures: `tests/fixtures/contract/cyberark/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_cyberark_adapter.py`
