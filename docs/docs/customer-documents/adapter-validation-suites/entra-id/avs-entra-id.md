...
# Adapter Validation Suite — Microsoft Entra ID
...
- Tier 2 contract fixtures: `tests/fixtures/contract/entra-id/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_entra_id_adapter.py`
