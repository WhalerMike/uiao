...
# Adapter Validation Suite — Infoblox DDI
...
- Tier 2 contract fixtures: `tests/fixtures/contract/infoblox/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_infoblox_adapter.py`
