...
# Adapter Validation Suite — ScubaGear
...
- Tier 2 contract fixtures: `tests/fixtures/contract/scubagear/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_scubagear_adapter.py`
