...
# Adapter Validation Suite — STIG Compliance
...
| Tier | Name | Status |
|------|------|--------|
| T1 | Live commercial-tenant tests | green |
| T2 | Contract tests (fixtures) | green |
| T3 | Reference deployment | pending |
...
- Tier 2 contract fixtures: `tests/fixtures/contract/stig-compliance/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_stig_compliance_adapter.py`
