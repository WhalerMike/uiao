...
# Adapter Validation Suite — Microsoft 365
...
- Tier 2 contract fixtures: `tests/fixtures/contract/m365/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_m365_adapter.py`
