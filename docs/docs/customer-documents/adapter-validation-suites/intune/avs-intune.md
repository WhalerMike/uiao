...
# Adapter Validation Suite — Microsoft Intune
...
- Tier 2 contract fixtures: `tests/fixtures/contract/intune/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_intune_adapter.py`
