---
title: "AVS — ServiceNow"
doc-type: adapter-validation-suite
adapter-id: servicenow
adapter-status: beta
...
# Adapter Validation Suite — ServiceNow
...
- Tier 2 contract fixtures: `tests/fixtures/contract/servicenow/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_servicenow_adapter.py`
