...
# Adapter Validation Suite — Patch State
...
- Tier 2 contract fixtures: `tests/fixtures/contract/patch-state/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_patch_state_adapter.py`
