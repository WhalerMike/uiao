---
title: "AVS — Vulnerability Scanner"
...
# Adapter Validation Suite — Vulnerability Scanner
...
- Tier 2 contract fixtures: `tests/fixtures/contract/vuln-scan/`
- All Domain 2.1–2.7 criteria validated offline, no live tenant required
- Extension methods validated in `tests/test_vuln_scan_adapter.py`
