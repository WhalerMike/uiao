...
**Implementation:** `uiao-impl/src/uiao/impl/adapters/paloalto_adapter.py` + `paloalto_parser.py` (real PAN-OS XML parsing). End-to-end OSCAL SAR generation proven via 6 integration tests.
