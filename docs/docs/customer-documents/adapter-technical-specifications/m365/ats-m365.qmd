...
**Implementation:** `uiao-impl/src/uiao/impl/adapters/m365_adapter.py` + `m365_parser.py` (real Graph API response parsing with entity normalization, security policy parsing, multi-workload tenant config parsing, and baseline comparison). End-to-end OSCAL SAR generation proven via 5 integration tests.
