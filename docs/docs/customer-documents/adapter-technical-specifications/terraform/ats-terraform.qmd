...
**Implementation:** `uiao-impl/src/uiao/impl/adapters/terraform_adapter.py` + `terraform_parser.py` (real parsing, not stubs). End-to-end OSCAL SAR generation proven via 7 integration tests.
