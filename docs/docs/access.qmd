...
- **Canon Overview:** [/canon/](canon/index.qmd)
- **Corpus Status Dashboard:** [/canon/corpus-status-dashboard/](canon/corpus-status-dashboard.qmd)
...
- **Contributing Guide:** [contributing.qmd](contributing.qmd)
...
- ADR metadata contract for ADR files (see [ADR Metadata Contract](meta/adr-metadata-contract.qmd))

## Governance

Metadata contracts:

- **ADR metadata:** [ADR Metadata Contract](meta/adr-metadata-contract.qmd)
