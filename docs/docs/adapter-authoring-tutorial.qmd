...
adapter, read [`quickstart.qmd`](quickstart.qmd) instead.
...
Your `demo` adapter is single-file: `uiao.adapters.demo_adapter`
(scaffolded by the bootstrap script during the tutorial).
...
- **Modernization adapters:** the invariants differ — read
  ...
  [`src/uiao/adapters/customer-documents/reference-architecture/active_directory/`](../../src/uiao/adapters/customer-documents/reference-architecture/active_directory/)
...
- **Historical guide:** [`adapter-development-guide.qmd`](adapter-development-guide.qmd)
