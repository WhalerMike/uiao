---
title: "Appendix E — SCuBA Field Dictionary"
subtitle: "SCuBA field reference and definitions"
---
...
- Changes to this schema require an ADR (see [Appendix D](Appendix-D-ADR-Index.qmd))
...
- [Appendix B — UIAO SCuBA Pipeline](Appendix-B-UIAO-SCuBA-Pipeline.qmd)
- [Appendix C — KSI Mapping Tables](Appendix-C-KSI-Mapping-Tables.qmd)
- [Appendix D — ADR Index](Appendix-D-ADR-Index.qmd)
- [SCuBA Pipeline Runbook](../docs/SCuBA-Pipeline-Runbook.qmd)
