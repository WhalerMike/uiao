...
- **CISA [BOD 25-01](https://cyber.dhs.gov/bod/25-01/)** — emergency directive compliance for covered assets
...
domains:
  - id: identity
    ...
    status: active
    canonical-source: canon/customer-documents/reference-architecture/identity.md
    docs-required:
...
├── TREE.qmd                          # authoritative directory tree
