...
- **CISA [BOD 25-01](https://cyber.dhs.gov/bod/25-01/)**: device-state visibility weakened; "rapid
...
2. **MAS 2026** boundary refinement (live since 2026-06-24, required
   for 20x since 2026-07-04) narrowing scope so Microsoft's commercial
   endpoint-analytics ML pipeline sits outside the agency ATO.
