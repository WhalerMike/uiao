...
- **CISA [BOD 25-01](https://cyber.dhs.gov/bod/25-01/)**: not directly mandating CAE but closely aligned
...
2. **MAS 2026** boundary refinement (live since 2026-06-24, required
   for 20x since 2026-07-04) that places Entra real-time signaling
   outside the agency ATO scope — same mechanism as FINDING-005.
