...
requirement of CISA [BOD 25-01](https://cyber.dhs.gov/bod/25-01/) is harder to satisfy** as a result.
...
`src/uiao/adapters/customer-documents/reference-architecture/gcc_boundary_probe/queries/`).
...
2. **MAS 2026** boundary refinement (live since 2026-06-24, required
   for 20x since 2026-07-04) — Microsoft's Intune commercial analytics
   pipeline outside the agency ATO scope.
