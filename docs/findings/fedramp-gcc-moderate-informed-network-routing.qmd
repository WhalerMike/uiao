...
- [FINDING-PGM-001 — FedRAMP 20x Moderate Pilot active](./fedramp-20x-moderate-pilot.qmd)
  ...
  *"FedRAMP authorization package for GCC-Moderate permits the
  ...
  independently of FINDING-PGM-001.
...
- [B.1.3 Rebuilding Boundary-Blocked Analytics In-Boundary](../customer-documents/compliance/boundary-authorization/B1-3-rebuilding-boundary-blocked-analytics.qmd)
  — formalizes the §4 internal-remedy (the agency-side path-quality collector)
  as the Networks-pillar substitute, and places INR in the full 26-row
  fix-coverage matrix (`inr-realtime-path-metrics`: *partial — substitute*; an
  agency-owned source, never Microsoft's path intelligence). The ADR-057
  ThousandEyes scoping of that substitute is in
  [B.1.2 §4b](../customer-documents/compliance/boundary-authorization/B1-2-teams-phone-tic2-centralized-dia.qmd).
...
| 2026-06-26 | Awaiting-External-Remediation | Cross-linked to B.1.3 in-boundary rebuild plan (Networks-pillar substitute); no status change |
