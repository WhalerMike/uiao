...
- **CISA [BOD 25-01](https://cyber.dhs.gov/bod/25-01/)**: core call-quality logging unaffected.
...
2. **Long-term forensic store** — 1+ year for general audit; 10 years
   ...
   §13.2).
3. **Retention SLA** documented in the SSP under M-26-14 maturity Level 3 (Advanced)
...
2. **MAS 2026** boundary refinement (live since 2026-06-24, required
   for 20x since 2026-07-04) — see FINDING-005 / FINDING-006 for the
   same mechanism applied to identity / CAE telemetry.
