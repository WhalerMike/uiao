...
These tests exercise uiao_core.scuba.transform.transform_scuba_to_ir
...
from uiao_core.scuba.transform import (
...
def test_ir_result_to_dict_schema():
    from uiao_core.ir.adapters.scuba.transformer import transform_scuba_to_ir as _core
