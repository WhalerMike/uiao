"""Tests for uiao.evidence and uiao.models.evidence modules.
...
from uiao.models.evidence import EvidenceArtifact, EvidenceBundle, EvidenceMap
...
class TestEvidenceLinker:
    ...
    def test_fedramp_ns_on_all_props(self, sample_artifact: EvidenceArtifact) -> None:
        ...
        from uiao.evidence.linker import FEDRAMP_NS, EvidenceLinker
...
class TestEvidenceCollector:
    def test_import_package(self) -> None:
        from uiao.evidence import EvidenceBundler, EvidenceCollector, EvidenceLinker
    ...
    def test_collector_stub_returns_artifacts(self) -> None:
        from uiao.evidence.collector import AzureSentinelCollector, VulnScanCollector
    ...
    def test_manual_upload_missing_yaml_returns_empty(self) -> None:
        from uiao.evidence.collector import ManualUploadCollector
    ...
    def test_collector_connector_error_does_not_propagate(self) -> None:
        ...
        from uiao.evidence.collector import BaseCollector, EvidenceCollector
    ...
    def test_vuln_scan_with_files(self, tmp_path: Path) -> None:
        ...
        from uiao.evidence.collector import VulnScanCollector
