...
VALID = {
    'assessment_metadata': {'run_id': 'x', 'assessment_date': '2025-01-01T00:00:00Z', 'tool_version': '1.0', 'collector_user': 'ci'},
    'tenant': {'tenant_id': 't1'},
...
def test_missing_metadata_key(tmp_path):
    p = tmp_path / 'b.json'
    p.write_text(json.dumps({**VALID, 'assessment_metadata': {'run_id': 'x', 'assessment_date': '2025-01-01T00:00:00Z'}}))
    r = validate_normalized_json(str(p))
