import json
import pytest
from uiao_core.diff.engine import diff_runs, format_diff_markdown, format_diff_json
from uiao_core.ir.adapters.scuba.transformer import transform_scuba_to_ir

def _run(tmp_path, name, ksi_results):
    data = {
        'assessment_metadata': {'run_id': name, 'assessment_date': '2025-01-01T00:00:00Z', 'tool_version': '1.0', 'collector_user': 'ci'},
        'tenant': {'tenant_id': 't1'},
