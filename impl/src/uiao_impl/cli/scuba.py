"""uiao_impl.cli.scuba — Typer sub-application for the SCuBA→IR plane.
...
mounted by ``uiao_impl.cli.app`` via ``app.add_typer()``.
"""
...
def transform_cmd(  # noqa: B008
    ...
    """
    from uiao_impl.scuba.transform import transform_scuba_to_ir
