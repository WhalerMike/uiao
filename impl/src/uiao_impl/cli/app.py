...
from uiao_impl.__version__ import __version__
...
def generate_visuals(
    ...
    from uiao_impl.generators.mermaid import render_all_plantuml
...
def generate_gemini(
    ...
    from uiao_impl.generators.gemini_visuals import (
...
def generate_pptx(
    ...
    from uiao_impl.generators.pptx import build_pptx
...
def generate_artifacts(
    ...
    if os.environ.get("GEMINI_API_KEY", "").strip():
        from uiao_impl.generators.gemini_visuals import generate_all_gemini_images
...
def generate_sbom(
    ...
    from uiao_impl.generators.sbom import build_sbom
...
def generate_all(
    ...
    from uiao_impl.generators.pptx import build_pptx
    from uiao_impl.generators.rich_docx import build_rich_docx, generate_all_topic_docs
    from uiao_impl.generators.sbom import build_sbom
    from uiao_impl.generators.ssp import build_ssp
...
def adapter_run(
    ...
    adapter_registry = {
        "servicenow": "uiao_impl.adapters.servicenow_adapter.ServiceNowAdapter",
        "entra": "uiao_impl.adapters.entra_adapter.EntraAdapter",
    }
...
def generate_briefing(
    ...
    from uiao_impl.generators.briefing import build_briefing
...
def adapter_run_scuba(
    ...
    from uiao_impl.adapters.scuba_adapter import ScubaAdapter
...
def ir_evidence_bundle(
    ...
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
...
def ir_poam_export(
    ...
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.evidence.poam import build_poam, poam_summary, poam_to_json
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
...
def ir_governance_report(
    ...
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.governance.actions import build_governance_actions
    from uiao_impl.governance.report import format_governance_report
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
...
def ir_ssp_report(
    ...
    from uiao_impl.coverage.coverage import build_coverage_links
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.governance.actions import build_governance_actions
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
    from uiao_impl.ssp.lineage import build_lineage_index
    from uiao_impl.ssp.narrative import build_control_narratives, format_ssp_markdown
...
def ir_diff(
    ...
    from uiao_impl.diff.engine import diff_runs, format_diff_json, format_diff_markdown
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
...
def ir_validate(
    ...
    from uiao_impl.validators.ir_validator import validate_normalized_json
...
def ir_freshness(
    ...
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.freshness.engine import build_freshness_records, generate_refresh_actions
    from uiao_impl.governance.actions import build_governance_actions
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
...
def ir_dashboard(
    ...
    from uiao_impl.dashboard.ir_dashboard import export_ir_dashboard
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.governance.actions import build_governance_actions
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
    ...
    if out:
        ...
        from uiao_impl.dashboard.ir_dashboard import build_ir_dashboard
...
def ir_freshness_schedule(
    ...
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.freshness.engine import build_freshness_records, generate_refresh_actions
    from uiao_impl.freshness.scheduler import build_refresh_schedule, schedule_summary
    from uiao_impl.governance.actions import build_governance_actions
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
...
def ir_generate_sar(
    ...
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.generators.sar import build_sar, build_sar_summary, export_sar
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
...
def ir_ssp_inject(
    ...
    from uiao_impl.evidence.bundle import build_bundle_from_transform_result
    from uiao_impl.generators.ssp_inject import build_live_ssp, live_ssp_summary
    from uiao_impl.ir.adapters.scuba.transformer import transform_scuba_to_ir
