"""uiao_impl.cli.oscal — Typer sub-app for the `uiao oscal` command group.

Mount point
-----------
    # in uiao_impl/cli/app.py
    from uiao_impl.cli.oscal import oscal_app
...
Or via module invocation:
    python -m uiao_impl.cli oscal generate \\
        --evidence ./output/evidence/tenant-a/ \\
        --output   ./output/artifacts/tenant-a/
"""
...
from uiao_impl.oscal.generator import generate_oscal
...
def generate_command(
    ...
    `uiao_impl.oscal.generator.generate_oscal`, which is kept
