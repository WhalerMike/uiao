...
File: src/uiao_impl/adapters/scuba_adapter.py
"""
...
SCUBA_TO_KSI_MAP: Dict[str, str] = {
    ...
    "MS.DEFENDER.1.2v1": "SI-3",
    "MS.DEFENDER.1.3v1": "SI-3",
    "MS.DEFENDER.1.4v1": "SI-4",
    "MS.DEFENDER.1.5v1": "SI-3",
    "MS.DEFENDER.2.1v1": "SI-8",
    "MS.DEFENDER.2.2v1": "SI-8",
    "MS.DEFENDER.2.3v1": "SI-8",
    "MS.DEFENDER.4.1v2": "SI-4",
    # Exchange Online
    "MS.EXO.3.1v1": "SC-8(1)",
    "MS.EXO.6.1v1": "SI-8",
    "MS.EXO.16.1v1": "SI-3",
    # SharePoint
    "MS.SHAREPOINT.1.1v1": "AC-3",
    "MS.SHAREPOINT.1.2v1": "AC-3",
    "MS.SHAREPOINT.1.3v1": "AC-20",
    "MS.SHAREPOINT.2.1v1": "AU-3",
    "MS.SHAREPOINT.2.2v1": "AU-3",
    "MS.SHAREPOINT.3.1v1": "SC-28",
    "MS.SHAREPOINT.3.2v1": "SC-8(1)",
    "MS.SHAREPOINT.3.3v1": "MP-5",
    # Teams
    "MS.TEAMS.1.1v1": "AC-6",
    "MS.TEAMS.1.2v2": "AC-3",
    "MS.TEAMS.1.3v1": "AC-3",
    ...
    "MS.TEAMS.2.2v2": "AU-3",
    "MS.TEAMS.2.3v2": "AU-6",
    "MS.TEAMS.4.1v1": "AC-12",
    "MS.TEAMS.5.1v2": "SI-8",
    "MS.TEAMS.5.2v2": "SI-8",
    "MS.TEAMS.5.3v2": "AC-3",
    # Power Platform
    "MS.POWERPLATFORM.1.1v1": "AC-3",
    "MS.POWERPLATFORM.1.2v1": "AC-3",
    "MS.POWERPLATFORM.2.1v1": "AC-3",
    "MS.POWERPLATFORM.2.2v1": "CM-6",
    "MS.POWERPLATFORM.3.1v1": "AC-3",
    "MS.POWERPLATFORM.3.2v1": "AC-3",
    "MS.POWERPLATFORM.4.1v1": "CM-6",
    "MS.POWERPLATFORM.5.1v1": "AC-3",
    "MS.POWERPLATFORM.6.1v1": "AC-3",
    # Power BI
    "MS.POWERBI.1.1v1": "AC-3",
    "MS.POWERBI.2.1v1": "AC-3",
    "MS.POWERBI.3.1v1": "SC-28",
    "MS.POWERBI.4.1v1": "MP-5",
    "MS.POWERBI.4.2v1": "AU-3",
    "MS.POWERBI.5.1v1": "AC-3",
    "MS.POWERBI.6.1v1": "CM-6",
    "MS.POWERBI.7.1v1": "SI-8",
    # Security Suite
    "MS.SECURITYSUITE.1.1v1": "SI-3",
    "MS.SECURITYSUITE.1.2v1": "SI-8",
    "MS.SECURITYSUITE.1.3v1": "IR-4",
    "MS.SECURITYSUITE.1.4v1": "IR-5",
    "MS.SECURITYSUITE.2.1v1": "CM-6",
    "MS.SECURITYSUITE.2.2v1": "CM-7",
    "MS.SECURITYSUITE.2.3v1": "CM-6",
    "MS.SECURITYSUITE.3.1v1": "SC-28",
    "MS.SECURITYSUITE.3.2v1": "SC-8(1)",
    "MS.SECURITYSUITE.3.3v1": "MP-5",
    "MS.SECURITYSUITE.3.4v1": "AC-3",
    "MS.SECURITYSUITE.3.5v1": "AU-3",
    "MS.SECURITYSUITE.4.1v1": "AC-2",
    "MS.SECURITYSUITE.4.2v1": "AC-6",
    "MS.SECURITYSUITE.5.1v1": "IA-2",
    "MS.SECURITYSUITE.5.2v1": "IA-5",
    "MS.SECURITYSUITE.6.1v1": "AU-2",
    "MS.SECURITYSUITE.6.2v1": "AU-3",
    "MS.SECURITYSUITE.7.1v1": "SC-7",
    "MS.SECURITYSUITE.7.2v1": "AC-20",
    "MS.SECURITYSUITE.7.3v1": "SC-8(1)",
    "MS.SECURITYSUITE.8.1v1": "IR-4",
    "MS.SECURITYSUITE.8.2v1": "IR-5",
}
