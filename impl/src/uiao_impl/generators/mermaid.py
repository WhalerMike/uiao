...
def build_mermaid_visuals(*args: object, **kwargs: object) -> Path:
    ...
    raise RuntimeError(
        "build_mermaid_visuals() has been removed. Use build_plantuml_visuals() from uiao_impl.generators.plantuml."
    )
...
def render_mermaid_file(*args: object, **kwargs: object) -> Path | None:
    ...
    raise RuntimeError(
        "render_mermaid_file() has been removed. Use render_plantuml_file() from uiao_impl.generators.plantuml."
    )
...
def render_all_mermaid(*args: object, **kwargs: object) -> list[Path]:
    ...
    raise RuntimeError(
        "render_all_mermaid() has been removed. Use render_all_plantuml() from uiao_impl.generators.plantuml."
    )
