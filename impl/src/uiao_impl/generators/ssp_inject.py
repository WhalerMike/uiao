...
resulting :class:`~uiao_impl.evidence.bundle.EvidenceBundle` into an OSCAL SSP
...
from uiao_impl.evidence.bundle import EvidenceBundle, build_bundle_from_transform_result
...
def inject_scuba_evidence(
    ...
    :class:`~uiao_impl.evidence.bundle.EvidenceBundle` requirement the function:
...
def live_ssp_summary(ssp_doc: dict[str, Any], bundle: EvidenceBundle) -> str:
    ...
    bundle:
        The :class:`~uiao_impl.evidence.bundle.EvidenceBundle` that was injected.
