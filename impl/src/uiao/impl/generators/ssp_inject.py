...
resulting :class:`~uiao.impl.evidence.bundle.EvidenceBundle` into an OSCAL SSP
...
def inject_scuba_evidence(
    ...
    :class:`~uiao.impl.evidence.bundle.EvidenceBundle` requirement the function:
...
def live_ssp_summary(ssp_doc: dict[str, Any], bundle: EvidenceBundle) -> str:
    ...
    bundle:
        The :class:`~uiao.impl.evidence.bundle.EvidenceBundle` that was injected.
