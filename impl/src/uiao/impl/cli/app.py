...
from uiao.impl.__version__ import __version__
...
def generate_visuals(
    ...
    from uiao.impl.generators.mermaid import render_all_plantuml
...
def generate_gemini(
    ...
    from uiao.impl.generators.gemini_visuals import (
...
def generate_artifacts(
    ...
    if os.environ.get("GEMINI_API_KEY", "").strip():
        from uiao.impl.generators.gemini_visuals import generate_all_gemini_images
...
def generate_sbom(
    ...
    from uiao.impl.generators.sbom import build_sbom
...
def generate_all(
    ...
    from uiao.impl.generators.pptx import build_pptx
    from uiao.impl.generators.rich_docx import build_rich_docx, generate_all_topic_docs
    from uiao.impl.generators.sbom import build_sbom
    from uiao.impl.generators.ssp import build_ssp
...
def generate_briefing(
    ...
    from uiao.impl.generators.briefing import build_briefing
...
def adapter_run_scuba(
    ...
    from uiao.impl.adapters.scubagear_adapter import ScubaGearAdapter
...
def ir_dashboard(
    ...
    if out:
        ...
        from uiao.impl.dashboard.ir_dashboard import build_ir_dashboard
...
# ---------------------------------------------------------------------------
from uiao.impl.cli.scuba import scuba_app  # noqa: E402

app.add_typer(scuba_app, name="scuba")
from uiao.impl.cli.ksi import ksi_app  # noqa: E402

app.add_typer(ksi_app, name="ksi")
from uiao.impl.cli.evidence import evidence_app  # noqa: E402

app.add_typer(evidence_app, name="evidence")
from uiao.impl.cli.oscal import oscal_app  # noqa: E402

app.add_typer(oscal_app, name="oscal")
from uiao.impl.cli.substrate import substrate_app  # noqa: E402
