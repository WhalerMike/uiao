"""uiao.impl.cli.ksi — Typer sub-app for the `uiao ksi` command group.

Mount point
-----------
    # in uiao/impl/cli/app.py
    from uiao.impl.cli.ksi import ksi_app
...
Or via module invocation:
    python -m uiao.impl.cli ksi evaluate \\
        --ir  ./output/ir/tenant-a.ir.json \\
        --out ./output/ksi/tenant-a.ksi.json
"""
...
def evaluate_command(
    ...
    It is a thin wrapper around `uiao.impl.ksi.evaluate.evaluate_ksi`,
