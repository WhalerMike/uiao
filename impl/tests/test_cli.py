"""Tests for uiao_impl.cli.app module."""
...
class TestCLIBasics:
    ...
    def test_generate_docs_runs(self, tmp_path) -> None:
        ...
        with patch(
            "uiao_impl.generators.docs.build_docs",
...
class TestGenerateAll:
    ...
    def test_generate_all_runs_all_steps(self, tmp_path) -> None:
        ...
        patches = [
            patch("uiao_impl.generators.plantuml.render_plantuml_dir", return_value=["img1.png", "img2.png"]),
            patch("uiao_impl.generators.docs.build_docs", return_value=["docs/a.md", "docs/b.md"]),
            patch("uiao_impl.generators.oscal.build_oscal", return_value=tmp_path / "oscal.json"),
            patch("uiao_impl.generators.ssp.build_ssp", return_value=tmp_path / "ssp.json"),
            patch("uiao_impl.generators.poam.build_poam_export", return_value=tmp_path / "poam.json"),
            patch("uiao_impl.generators.rich_docx.build_rich_docx", return_value=tmp_path / "brief.docx"),
            patch("uiao_impl.generators.pptx.build_pptx", return_value=tmp_path / "deck.pptx"),
            patch("uiao_impl.generators.sbom.build_sbom", return_value=tmp_path / "sbom.json"),
        ]
    ...
    def test_generate_all_skip_sbom(self, tmp_path) -> None:
        ...
        patches = [
            patch("uiao_impl.generators.plantuml.render_plantuml_dir", return_value=[]),
            patch("uiao_impl.generators.docs.build_docs", return_value=[]),
            patch("uiao_impl.generators.oscal.build_oscal", return_value=tmp_path / "o.json"),
            patch("uiao_impl.generators.ssp.build_ssp", return_value=tmp_path / "s.json"),
            patch("uiao_impl.generators.poam.build_poam_export", return_value=tmp_path / "p.json"),
            patch("uiao_impl.generators.rich_docx.build_rich_docx", return_value=tmp_path / "d.docx"),
            patch("uiao_impl.generators.pptx.build_pptx", return_value=tmp_path / "p.pptx"),
        ]
    ...
    def test_generate_all_partial_failure_exits_nonzero(self, tmp_path) -> None:
        ...
        patches = [
            patch("uiao_impl.generators.plantuml.render_plantuml_dir", return_value=[]),
            patch("uiao_impl.generators.docs.build_docs", side_effect=RuntimeError("template missing")),
            patch("uiao_impl.generators.oscal.build_oscal", return_value=tmp_path / "o.json"),
            patch("uiao_impl.generators.ssp.build_ssp", return_value=tmp_path / "s.json"),
            patch("uiao_impl.generators.poam.build_poam_export", return_value=tmp_path / "p.json"),
            patch("uiao_impl.generators.rich_docx.build_rich_docx", return_value=tmp_path / "d.docx"),
