...
def test_utils_context_imports():
    ...
    from uiao.utils.context import get_settings, load_canon, load_context
...
def test_utils_package_reexports():
    """uiao.utils re-exports context helpers."""
    from uiao.utils import get_settings
...
def test_trestle_generator_import():
    ...
    from uiao.generators.trestle import assemble_ssp
