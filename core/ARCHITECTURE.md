...
|---|---|---|---|
| 1 | ~~`uiao-gos` role~~ **RESOLVED** (superseded 2026-04-17) — See ADR-028: firewall retired, directory-migration subsystem integrated under `impl/src/uiao/impl/directory_migration/`; IPAM adapters registered in `core/canon/modernization-registry.yaml`. | — | — |
...
2. ~~Commit companion `uiao-gos/ARCHITECTURE.md`~~ — superseded by ADR-028: `uiao-gos` dissolved into `impl/src/uiao/impl/directory_migration/`; no separate architecture document needed.
