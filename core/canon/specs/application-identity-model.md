...
provenance:
  source: "inbox/Section 3 Application Identity.docx"
  version: "pre-UIAO draft"
...
The Application Identity primitive lives at the **Authority
Plane** of the Tier A four-layer model ratified by ADR-030 §2,
and is consumed by enforcement points at the **Overlay Fabric**
and **Physical Underlay** layers. The six-plane decomposition
(Tier B) surfaces it under the **Identity** control plane.
...
1. **Proposed** — requested via the onboarding runbook
...
- ADR-030 — Pre-UIAO Terminology Reconciliation (authorizes this spec)
