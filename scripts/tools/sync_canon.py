...
Propagates adapter-registry canon from `uiao` into the customer-documentation
...
See uiao/ARCHITECTURE.md §4 for the three-layer sync defense in depth.
"""
...
def main() -> int:
    ...
    ap.add_argument("--core-root", type=Path, required=True, help="Path to uiao repo root")
