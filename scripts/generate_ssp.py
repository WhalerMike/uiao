...
def build_ssp_skeleton(context):
    ...
    for plane in planes:
        ...
        ssp["system-implementations"]["components"].append({
            ...
            "props": [
                {"name": "pillar", "value": plane_id.upper()},
                {"name": "subtitle", "value": plane.get("subtitle", "")},
                {"name": "component-id", "value": component_id}
            ]
        })
    ...
    if inventory_items:
        ...
        ssp["system-implementations"]["system-inventory"] = oscal_inventory
...
def main():
    ...
    inventory = ssp_data.get("system-implementations", {}).get("system-inventory", [])
