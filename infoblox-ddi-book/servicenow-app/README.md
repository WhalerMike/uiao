...
- [ATF tests](./atf/README.md) — automated happy-path + negative tests, runnable in a sub-prod instance via `test_mode` (no live Infoblox).
- [Update set](./update-set/README.md) — the whole app assembled into one importable update-set XML (Script Includes, REST Message, variable sets, ATF tests, properties).
