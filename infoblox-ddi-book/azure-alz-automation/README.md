...
- **Microsoft** ships the [ALZ Bicep/Terraform Accelerators](https://azure.github.io/Azure-Landing-Zones/accelerator/)
...
- **Infoblox** ships the [official Terraform provider](https://github.com/infobloxopen/terraform-provider-infoblox),
  ...
  and the [Terraform NIOS deployment guide](https://docs.infoblox.com/space/DeploymentGuideTerraformNIOSProvider/807896547/Terraform+Resources)
